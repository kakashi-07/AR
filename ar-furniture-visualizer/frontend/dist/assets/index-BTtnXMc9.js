 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(R,V){var Y=R.length;R.push(V);e:for(;0<Y;){var te=Y-1>>>1,_e=R[te];if(0<r(_e,V))R[te]=V,R[Y]=_e,Y=te;else break e}}function n(R){return R.length===0?null:R[0]}function i(R){if(R.length===0)return null;var V=R[0],Y=R.pop();if(Y!==V){R[0]=Y;e:for(var te=0,_e=R.length,be=_e>>>1;te<be;){var $=2*(te+1)-1,ae=R[$],pe=$+1,he=R[pe];if(0>r(ae,Y))pe<_e&&0>r(he,ae)?(R[te]=he,R[pe]=Y,te=pe):(R[te]=ae,R[$]=Y,te=$);else if(pe<_e&&0>r(he,Y))R[te]=he,R[pe]=Y,te=pe;else break e}}return V}function r(R,V){var Y=R.sortIndex-V.sortIndex;return Y!==0?Y:R.id-V.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var a=Date,o=a.now();t.unstable_now=function(){return a.now()-o}}var l=[],c=[],d=1,h=null,f=3,m=!1,_=!1,x=!1,p=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(R){for(var V=n(c);V!==null;){if(V.callback===null)i(c);else if(V.startTime<=R)i(c),V.sortIndex=V.expirationTime,e(l,V);else break;V=n(c)}}function M(R){if(x=!1,v(R),!_)if(n(l)!==null)_=!0,I(P);else{var V=n(c);V!==null&&O(M,V.startTime-R)}}function P(R,V){_=!1,x&&(x=!1,u(L),L=-1),m=!0;var Y=f;try{for(v(V),h=n(l);h!==null&&(!(h.expirationTime>V)||R&&!N());){var te=h.callback;if(typeof te=="function"){h.callback=null,f=h.priorityLevel;var _e=te(h.expirationTime<=V);V=t.unstable_now(),typeof _e=="function"?h.callback=_e:h===n(l)&&i(l),v(V)}else i(l);h=n(l)}if(h!==null)var be=!0;else{var $=n(c);$!==null&&O(M,$.startTime-V),be=!1}return be}finally{h=null,f=Y,m=!1}}var C=!1,A=null,L=-1,T=5,y=-1;function N(){return!(t.unstable_now()-y<T)}function z(){if(A!==null){var R=t.unstable_now();y=R;var V=!0;try{V=A(!0,R)}finally{V?G():(C=!1,A=null)}}else C=!1}var G;if(typeof g=="function")G=function(){g(z)};else if(typeof MessageChannel<"u"){var q=new MessageChannel,Q=q.port2;q.port1.onmessage=z,G=function(){Q.postMessage(null)}}else G=function(){p(z,0)};function I(R){A=R,C||(C=!0,G())}function O(R,V){L=p(function(){R(t.unstable_now())},V)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(R){R.callback=null},t.unstable_continueExecution=function(){_||m||(_=!0,I(P))},t.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<R?Math.floor(1e3/R):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(R){switch(f){case 1:case 2:case 3:var V=3;break;default:V=f}var Y=f;f=V;try{return R()}finally{f=Y}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(R,V){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var Y=f;f=R;try{return V()}finally{f=Y}},t.unstable_scheduleCallback=function(R,V,Y){var te=t.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?te+Y:te):Y=te,R){case 1:var _e=-1;break;case 2:_e=250;break;case 5:_e=1073741823;break;case 4:_e=1e4;break;default:_e=5e3}return _e=Y+_e,R={id:d++,callback:V,priorityLevel:R,startTime:Y,expirationTime:_e,sortIndex:-1},Y>te?(R.sortIndex=Y,e(c,R),n(l)===null&&R===n(c)&&(x?(u(L),L=-1):x=!0,O(M,Y-te))):(R.sortIndex=_e,e(l,R),_||m||(_=!0,I(P))),R},t.unstable_shouldYield=N,t.unstable_wrapCallback=function(R){var V=f;return function(){var Y=f;f=V;try{return R.apply(this,arguments)}finally{f=Y}}}})(vg);gg.exports=vg;var sx=gg.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const nt=(t,e)=>{const n=U.forwardRef(({className:i,...r},s)=>U.createElement(xM,{ref:s,iconNode:e,className:Vv(`lucide-${vM(t)}`,i),...r}));return n.displayName=`${t}`,n};/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yd=nt("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const SM=nt("Camera",[["path",{d:"M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z",key:"1tc9qg"}],["circle",{cx:"12",cy:"13",r:"3",key:"1vg3eu"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const EM=nt("ChevronDown",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wM=nt("CircleAlert",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const TM=nt("CircleCheckBig",[["path",{d:"M22 11.08V12a10 10 0 1 1-5.93-9.14",key:"g774vq"}],["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const AM=nt("Download",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"7 10 12 15 17 10",key:"2ggqvy"}],["line",{x1:"12",x2:"12",y1:"15",y2:"3",key:"1vk2je"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const CM=nt("EyeOff",[["path",{d:"M9.88 9.88a3 3 0 1 0 4.24 4.24",key:"1jxqfv"}],["path",{d:"M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68",key:"9wicm4"}],["path",{d:"M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61",key:"1jreej"}],["line",{x1:"2",x2:"22",y1:"2",y2:"22",key:"a6p6uj"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bM=nt("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const RM=nt("ImagePlus",[["path",{d:"M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7",key:"31hg93"}],["line",{x1:"16",x2:"22",y1:"5",y2:"5",key:"ez7e4s"}],["line",{x1:"19",x2:"19",y1:"2",y2:"8",key:"1gkr8c"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const PM=nt("Layers",[["path",{d:"m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z",key:"8b97xw"}],["path",{d:"m22 17.65-9.17 4.16a2 2 0 0 1-1.66 0L2 17.65",key:"dd6zsq"}],["path",{d:"m22 12.65-9.17 4.16a2 2 0 0 1-1.66 0L2 12.65",key:"ep9fru"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const LM=nt("LogOut",[["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"1uf3rs"}],["polyline",{points:"16 17 21 12 16 7",key:"1gabdz"}],["line",{x1:"21",x2:"9",y1:"12",y2:"12",key:"1uyos4"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const NM=nt("Mail",[["rect",{width:"20",height:"16",x:"2",y:"4",rx:"2",key:"18n3k1"}],["path",{d:"m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7",key:"1ocrg3"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Sd=nt("Minus",[["path",{d:"M5 12h14",key:"1ays0h"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const DM=nt("Monitor",[["rect",{width:"20",height:"14",x:"2",y:"3",rx:"2",key:"48i651"}],["line",{x1:"8",x2:"16",y1:"21",y2:"21",key:"1svkeh"}],["line",{x1:"12",x2:"12",y1:"17",y2:"21",key:"vw1qmm"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ul=nt("Plus",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const IM=nt("RefreshCcw",[["path",{d:"M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"14sxne"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}],["path",{d:"M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16",key:"1hlbsb"}],["path",{d:"M16 16h5v5",key:"ccwih5"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Md=nt("RotateCcw",[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ed=nt("RotateCw",[["path",{d:"M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8",key:"1p45f6"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}]]);/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`)+`
`+u);const v=g+p+a,M=g+u+o,P=Um(r,r.VERTEX_SHADER,v),C=Um(r,r.FRAGMENT_SHADER,M);r.attachShader(x,P),r.attachShader(x,C),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function A(N){if(t.debug.checkShaderErrors){const z=r.getProgramInfoLog(x).trim(),G=r.getShaderInfoLog(P).trim(),q=r.getShaderInfoLog(C).trim();let Q=!0,I=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(Q=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,P,C);else{const O=Fm(r,P,"vertex"),R=Fm(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
Program Info Log: `+z+`
`+O+`
`+R)}else z!==""?console.warn("THREE.WebGLProgram: Program Info Log:",z):(G===""||q==="")&&(I=!1);I&&(N.diagnostics={runnable:Q,programLog:z,vertexShader:{log:G,prefix:p},fragmentShader:{log:q,prefix:u}})}r.deleteShader(P),r.deleteShader(C),L=new ul(r,x),T=oC(r,x)}let L;this.getUniforms=function(){return L===void 0&&A(this),L};let T;this.getAttributes=function(){return T===void 0&&A(this),T};let y=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return y===!1&&(y=r.getProgramParameter(x,QA)),y},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(x),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=JA++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=P,this.fragmentShader=C,this}let xC=0;class yC{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const n=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(n),s=this._getShaderStage(i),a=this._getShaderCacheForMaterial(e);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new SC(e),n.set(e,i)),i}}class SC{constructor(e){this.id=xC++,this.code=e,this.usedTimes=0}}function MC(t,e,n,i,r,s,a){const o=new fh,l=new yC,c=new Set,d=[],h=r.logarithmicDepthBuffer,f=r.vertexTextures;let m=r.precision;const _={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(T){return c.add(T),T===0?"uv":`uv${T}`}function p(T,y,N,z,G){const q=z.fog,Q=G.geometry,I=T.isMeshStandardMaterial?z.environment:null,O=(T.isMeshStandardMaterial?n:e).get(T.envMap||I),R=O&&O.mapping===uc?O.image.height:null,V=_[T.type];T.precision!==null&&(m=r.getMaxPrecision(T.precision),m!==T.precision&&console.warn("THREE.WebGLProgram.getParameters:",T.precision,"not supported, using",m,"instead."));const Y=Q.morphAttributes.position||Q.morphAttributes.normal||Q.morphAttributes.color,te=Y!==void 0?Y.length:0;let _e=0;Q.morphAttributes.position!==void 0&&(_e=1),Q.morphAttributes.normal!==void 0&&(_e=2),Q.morphAttributes.color!==void 0&&(_e=3);let be,$,ae,pe;if(V){const Ke=Yn[V];be=Ke.vertexShader,$=Ke.fragmentShader}else be=T.vertexShader,$=T.fragmentShader,l.update(T),ae=l.getVertexShaderID(T),pe=l.getFragmentShaderID(T);const he=t.getRenderTarget(),Le=G.isInstancedMesh===!0,Fe=G.isBatchedMesh===!0,ke=!!T.map,it=!!T.matcap,D=!!O,ut=!!T.aoMap,Ye=!!T.lightMap,K=!!T.bumpMap,Z=!!T.normalMap,xe=!!T.displacementMap,se=!!T.emissiveMap,le=!!T.metalnessMap,b=!!T.roughnessMap,E=T.anisotropy>0,W=T.clearcoat>0,ie=T.dispersion>0,re=T.iridescence>0,J=T.sheen>0,Ce=T.transmission>0,ge=E&&!!T.anisotropyMap,Me=W&&!!T.clearcoatMap,ze=W&&!!T.clearcoatNormalMap,ce=W&&!!T.clearcoatRoughnessMap,Se=re&&!!T.iridescenceMap,Xe=re&&!!T.iridescenceThicknessMap,Ue=J&&!!T.sheenColorMap,Ee=J&&!!T.sheenRoughnessMap,Oe=!!T.specularMap,He=!!T.specularColorMap,dt=!!T.specularIntensityMap,F=Ce&&!!T.transmissionMap,ue=Ce&&!!T.thicknessMap,ee=!!T.gradientMap,ne=!!T.alphaMap,fe=T.alphaTest>0,Ne=!!T.alphaHash,$e=!!T.extensions;let xt=Yi;T.toneMapped&&(he===null||he.isXRRenderTarget===!0)&&(xt=t.toneMapping);const Nt={shaderID:V,shaderType:T.type,shaderName:T.name,vertexShader:be,fragmentShader:$,defines:T.defines,customVertexShaderID:ae,customFragmentShaderID:pe,isRawShaderMaterial:T.isRawShaderMaterial===!0,glslVersion:T.glslVersion,precision:m,batching:Fe,batchingColor:Fe&&G._colorsTexture!==null,instancing:Le,instancingColor:Le&&G.instanceColor!==null,instancingMorph:Le&&G.morphTexture!==null,supportsVertexTextures:f,outputColorSpace:he===null?t.outputColorSpace:he.isXRRenderTarget===!0?he.texture.colorSpace:tr,alphaToCoverage:!!T.alphaToCoverage,map:ke,matcap:it,envMap:D,envMapMode:D&&O.mapping,envMapCubeUVHeight:R,aoMap:ut,lightMap:Ye,bumpMap:K,normalMap:Z,displacementMap:f&&xe,emissiveMap:se,normalMapObjectSpace:Z&&T.normalMapType===LE,normalMapTangentSpace:Z&&T.normalMapType===i_,metalnessMap:le,roughnessMap:b,anisotropy:E,anisotropyMap:ge,clearcoat:W,clearcoatMap:Me,clearcoatNormalMap:ze,clearcoatRoughnessMap:ce,dispersion:ie,iridescence:re,iridescenceMap:Se,iridescenceThicknessMap:Xe,sheen:J,sheenColorMap:Ue,sheenRoughnessMap:Ee,specularMap:Oe,specularColorMap:He,specularIntensityMap:dt,transmission:Ce,transmissionMap:F,thicknessMap:ue,gradientMap:ee,opaque:T.transparent===!1&&T.blending===Es&&T.alphaToCoverage===!1,alphaMap:ne,alphaTest:fe,alphaHash:Ne,combine:T.combine,mapUv:ke&&x(T.map.channel),aoMapUv:ut&&x(T.aoMap.channel),lightMapUv:Ye&&x(T.lightMap.channel),bumpMapUv:K&&x(T.bumpMap.channel),normalMapUv:Z&&x(T.normalMap.channel),displacementMapUv:xe&&x(T.displacementMap.channel),emissiveMapUv:se&&x(T.emissiveMap.channel),metalnessMapUv:le&&x(T.metalnessMap.channel),roughnessMapUv:b&&x(T.roughnessMap.channel),anisotropyMapUv:ge&&x(T.anisotropyMap.channel),clearcoatMapUv:Me&&x(T.clearcoatMap.channel),clearcoatNormalMapUv:ze&&x(T.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ce&&x(T.clearcoatRoughnessMap.channel),iridescenceMapUv:Se&&x(T.iridescenceMap.channel),iridescenceThicknessMapUv:Xe&&x(T.iridescenceThicknessMap.channel),sheenColorMapUv:Ue&&x(T.sheenColorMap.channel),sheenRoughnessMapUv:Ee&&x(T.sheenRoughnessMap.channel),specularMapUv:Oe&&x(T.specularMap.channel),specularColorMapUv:He&&x(T.specularColorMap.channel),specularIntensityMapUv:dt&&x(T.specularIntensityMap.channel),transmissionMapUv:F&&x(T.transmissionMap.channel),thicknessMapUv:ue&&x(T.thicknessMap.channel),alphaMapUv:ne&&x(T.alphaMap.channel),vertexTangents:!!Q.attributes.tangent&&(Z||E),vertexColors:T.vertexColors,vertexAlphas:T.vertexColors===!0&&!!Q.attributes.color&&Q.attributes.color.itemSize===4,pointsUvs:G.isPoints===!0&&!!Q.attributes.uv&&(ke||ne),fog:!!q,useFog:T.fog===!0,fogExp2:!!q&&q.isFogExp2,flatShading:T.flatShading===!0,sizeAttenuation:T.sizeAttenuation===!0,logarithmicDepthBuffer:h,skinning:G.isSkinnedMesh===!0,morphTargets:Q.morphAttributes.position!==void 0,morphNormals:Q.morphAttributes.normal!==void 0,morphColors:Q.morphAttributes.color!==void 0,morphTargetsCount:te,morphTextureStride:_e,numDirLights:y.directional.length,numPointLights:y.point.length,numSpotLights:y.spot.length,numSpotLightMaps:y.spotLightMap.length,numRectAreaLights:y.rectArea.length,numHemiLights:y.hemi.length,numDirLightShadows:y.directionalShadowMap.length,numPointLightShadows:y.pointShadowMap.length,numSpotLightShadows:y.spotShadowMap.length,numSpotLightShadowsWithMaps:y.numSpotLightShadowsWithMaps,numLightProbes:y.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:T.dithering,shadowMapEnabled:t.shadowMap.enabled&&N.length>0,shadowMapType:t.shadowMap.type,toneMapping:xt,decodeVideoTexture:ke&&T.map.isVideoTexture===!0&&et.getTransfer(T.map.colorSpace)===at,premultipliedAlpha:T.premultipliedAlpha,doubleSided:T.side===qn,flipSided:T.side===on,useDepthPacking:T.depthPacking>=0,depthPacking:T.depthPacking||0,index0AttributeName:T.index0AttributeName,extensionClipCullDistance:$e&&T.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:($e&&T.extensions.multiDraw===!0||Fe)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:T.customProgramCacheKey()};return Nt.vertexUv1s=c.has(1),Nt.vertexUv2s=c.has(2),Nt.vertexUv3s=c.has(3),c.clear(),Nt}function u(T){const y=[];if(T.shaderID?y.push(T.shaderID):(y.push(T.customVertexShaderID),y.push(T.customFragmentShaderID)),T.defines!==void 0)for(const N in T.defines)y.push(N),y.push(T.defines[N]);return T.isRawShaderMaterial===!1&&(g(y,T),v(y,T),y.push(t.outputColorSpace)),y.push(T.customProgramCacheKey),y.join()}function g(T,y){T.push(y.precision),T.push(y.outputColorSpace),T.push(y.envMapMode),T.push(y.envMapCubeUVHeight),T.push(y.mapUv),T.push(y.alphaMapUv),T.push(y.lightMapUv),T.push(y.aoMapUv),T.push(y.bumpMapUv),T.push(y.normalMapUv),T.push(y.displacementMapUv),T.push(y.emissiveMapUv),T.push(y.metalnessMapUv),T.push(y.roughnessMapUv),T.push(y.anisotropyMapUv),T.push(y.clearcoatMapUv),T.push(y.clearcoatNormalMapUv),T.push(y.clearcoatRoughnessMapUv),T.push(y.iridescenceMapUv),T.push(y.iridescenceThicknessMapUv),T.push(y.sheenColorMapUv),T.push(y.sheenRoughnessMapUv),T.push(y.specularMapUv),T.push(y.specularColorMapUv),T.push(y.specularIntensityMapUv),T.push(y.transmissionMapUv),T.push(y.thicknessMapUv),T.push(y.combine),T.push(y.fogExp2),T.push(y.sizeAttenuation),T.push(y.morphTargetsCount),T.push(y.morphAttributeCount),T.push(y.numDirLights),T.push(y.numPointLights),T.push(y.numSpotLights),T.push(y.numSpotLightMaps),T.push(y.numHemiLights),T.push(y.numRectAreaLights),T.push(y.numDirLightShadows),T.push(y.numPointLightShadows),T.push(y.numSpotLightShadows),T.push(y.numSpotLightShadowsWithMaps),T.push(y.numLightProbes),T.push(y.shadowMapType),T.push(y.toneMapping),T.push(y.numClippingPlanes),T.push(y.numClipIntersection),T.push(y.depthPacking)}function v(T,y){o.disableAll(),y.supportsVertexTextures&&o.enable(0),y.instancing&&o.enable(1),y.instancingColor&&o.enable(2),y.instancingMorph&&o.enable(3),y.matcap&&o.enable(4),y.envMap&&o.enable(5),y.normalMapObjectSpace&&o.enable(6),y.normalMapTangentSpace&&o.enable(7),y.clearcoat&&o.enable(8),y.iridescence&&o.enable(9),y.alphaTest&&o.enable(10),y.vertexColors&&o.enable(11),y.vertexAlphas&&o.enable(12),y.vertexUv1s&&o.enable(13),y.vertexUv2s&&o.enable(14),y.vertexUv3s&&o.enable(15),y.vertexTangents&&o.enable(16),y.anisotropy&&o.enable(17),y.alphaHash&&o.enable(18),y.batching&&o.enable(19),y.dispersion&&o.enable(20),y.batchingColor&&o.enable(21),T.push(o.mask),o.disableAll(),y.fog&&o.enable(0),y.useFog&&o.enable(1),y.flatShading&&o.enable(2),y.logarithmicDepthBuffer&&o.enable(3),y.skinning&&o.enable(4),y.morphTargets&&o.enable(5),y.morphNormals&&o.enable(6),y.morphColors&&o.enable(7),y.premultipliedAlpha&&o.enable(8),y.shadowMapEnabled&&o.enable(9),y.doubleSided&&o.enable(10),y.flipSided&&o.enable(11),y.useDepthPacking&&o.enable(12),y.dithering&&o.enable(13),y.transmission&&o.enable(14),y.sheen&&o.enable(15),y.opaque&&o.enable(16),y.pointsUvs&&o.enable(17),y.decodeVideoTexture&&o.enable(18),y.alphaToCoverage&&o.enable(19),T.push(o.mask)}function M(T){const y=_[T.type];let N;if(y){const z=Yn[y];N=s1.clone(z.uniforms)}else N=T.uniforms;return N}function P(T,y){let N;for(let z=0,G=d.length;z<G;z++){const q=d[z];if(q.cacheKey===y){N=q,++N.usedTimes;break}}return N===void 0&&(N=new _C(t,y,T,s),d.push(N)),N}function C(T){if(--T.usedTimes===0){const y=d.indexOf(T);d[y]=d[d.length-1],d.pop(),T.destroy()}}function A(T){l.remove(T)}function L(){l.dispose()}return{getParameters:p,getProgramCacheKey:u,getUniforms:M,acquireProgram:P,releaseProgram:C,releaseShaderCache:A,programs:d,dispose:L}}function EC(){let t=new WeakMap;function e(s){let a=t.get(s);return a===void 0&&(a={},t.set(s,a)),a}function n(s){t.delete(s)}function i(s,a,o){t.get(s)[a]=o}function r(){t=new WeakMap}return{get:e,remove:n,update:i,dispose:r}}function wC(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.z!==e.z?t.z-e.z:t.id-e.id}function Vm(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function Hm(){const t=[];let e=0;const n=[],i=[],r=[];function s(){e=0,n.length=0,i.length=0,r.length=0}function a(h,f,m,_,x,p){let u=t[e];return u===void 0?(u={id:h.id,object:h,geometry:f,material:m,groupOrder:_,renderOrder:h.renderOrder,z:x,group:p},t[e]=u):(u.id=h.id,u.object=h,u.geometry=f,u.material=m,u.groupOrder=_,u.renderOrder=h.renderOrder,u.z=x,u.group=p),e++,u}function o(h,f,m,_,x,p){const u=a(h,f,m,_,x,p);m.transmission>0?i.push(u):m.transparent===!0?r.push(u):n.push(u)}function l(h,f,m,_,x,p){const u=a(h,f,m,_,x,p);m.transmission>0?i.unshift(u):m.transparent===!0?r.unshift(u):n.unshift(u)}function c(h,f){n.length>1&&n.sort(h||wC),i.length>1&&i.sort(f||Vm),r.length>1&&r.sort(f||Vm)}function d(){for(let h=e,f=t.length;h<f;h++){const m=t[h];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:o,unshift:l,finish:d,sort:c}}function TC(){let t=new WeakMap;function e(i,r){const s=t.get(i);let a;return s===void 0?(a=new Hm,t.set(i,[a])):r>=s.length?(a=new Hm,s.push(a)):a=s[r],a}function n(){t=new WeakMap}return{get:e,dispose:n}}function AC(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new H,color:new je};break;case"SpotLight":n={position:new H,direction:new H,color:new je,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new H,color:new je,distance:0,decay:0};break;case"HemisphereLight":n={direction:new H,skyColor:new je,groundColor:new je};break;case"RectAreaLight":n={color:new je,position:new H,halfWidth:new H,halfHeight:new H};break}return t[e.id]=n,n}}}function CC(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let bC=0;function RC(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function PC(t){const e=new AC,n=CC(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new H);const r=new H,s=new ct,a=new ct;function o(c){let d=0,h=0,f=0;for(let T=0;T<9;T++)i.probe[T].set(0,0,0);let m=0,_=0,x=0,p=0,u=0,g=0,v=0,M=0,P=0,C=0,A=0;c.sort(RC);for(let T=0,y=c.length;T<y;T++){const N=c[T],z=N.color,G=N.intensity,q=N.distance,Q=N.shadow&&N.shadow.map?N.shadow.map.texture:null;if(N.isAmbientLight)d+=z.r*G,h+=z.g*G,f+=z.b*G;else if(N.isLightProbe){for(let I=0;I<9;I++)i.probe[I].addScaledVector(N.sh.coefficients[I],G);A++}else if(N.isDirectionalLight){const I=e.get(N);if(I.color.copy(N.color).multiplyScalar(N.intensity),N.castShadow){const O=N.shadow,R=n.get(N);R.shadowIntensity=O.intensity,R.shadowBias=O.bias,R.shadowNormalBias=O.normalBias,R.shadowRadius=O.radius,R.shadowMapSize=O.mapSize,i.directionalShadow[m]=R,i.directionalShadowMap[m]=Q,i.directionalShadowMatrix[m]=N.shadow.matrix,g++}i.directional[m]=I,m++}else if(N.isSpotLight){const I=e.get(N);I.position.setFromMatrixPosition(N.matrixWorld),I.color.copy(z).multiplyScalar(G),I.distance=q,I.coneCos=Math.cos(N.angle),I.penumbraCos=Math.cos(N.angle*(1-N.penumbra)),I.decay=N.decay,i.spot[x]=I;const O=N.shadow;if(N.map&&(i.spotLightMap[P]=N.map,P++,O.updateMatrices(N),N.castShadow&&C++),i.spotLightMatrix[x]=O.matrix,N.castShadow){const R=n.get(N);R.shadowIntensity=O.intensity,R.shadowBias=O.bias,R.shadowNormalBias=O.normalBias,R.shadowRadius=O.radius,R.shadowMapSize=O.mapSize,i.spotShadow[x]=R,i.spotShadowMap[x]=Q,M++}x++}else if(N.isRectAreaLight){const I=e.get(N);I.color.copy(z).multiplyScalar(G),I.halfWidth.set(N.width*.5,0,0),I.halfHeight.set(0,N.height*.5,0),i.rectArea[p]=I,p++}else if(N.isPointLight){const I=e.get(N);if(I.color.copy(N.color).multiplyScalar(N.intensity),I.distance=N.distance,I.decay=N.decay,N.castShadow){const O=N.shadow,R=n.get(N);R.shadowIntensity=O.intensity,R.shadowBias=O.bias,R.shadowNormalBias=O.normalBias,R.shadowRadius=O.radius,R.shadowMapSize=O.mapSize,R.shadowCameraNear=O.camera.near,R.shadowCameraFar=O.camera.far,i.pointShadow[_]=R,i.pointShadowMap[_]=Q,i.pointShadowMatrix[_]=N.shadow.matrix,v++}i.point[_]=I,_++}else if(N.isHemisphereLight){const I=e.get(N);I.skyColor.copy(N.color).multiplyScalar(G),I.groundColor.copy(N.groundColor).multiplyScalar(G),i.hemi[u]=I,u++}}p>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=me.LTC_FLOAT_1,i.rectAreaLTC2=me.LTC_FLOAT_2):(i.rectAreaLTC1=me.LTC_HALF_1,i.rectAreaLTC2=me.LTC_HALF_2)),i.ambient[0]=d,i.ambient[1]=h,i.ambient[2]=f;const L=i.hash;(L.directionalLength!==m||L.pointLength!==_||L.spotLength!==x||L.rectAreaLength!==p||L.hemiLength!==u||L.numDirectionalShadows!==g||L.numPointShadows!==v||L.numSpotShadows!==M||L.numSpotMaps!==P||L.numLightProbes!==A)&&(i.directional.length=m,i.spot.length=x,i.rectArea.length=p,i.point.length=_,i.hemi.length=u,i.directionalShadow.length=g,i.directionalShadowMap.length=g,i.pointShadow.length=v,i.pointShadowMap.length=v,i.spotShadow.length=M,i.spotShadowMap.length=M,i.directionalShadowMatrix.length=g,i.pointShadowMatrix.length=v,i.spotLightMatrix.length=M+P-C,i.spotLightMap.length=P,i.numSpotLightShadowsWithMaps=C,i.numLightProbes=A,L.directionalLength=m,L.pointLength=_,L.spotLength=x,L.rectAreaLength=p,L.hemiLength=u,L.numDirectionalShadows=g,L.numPointShadows=v,L.numSpotShadows=M,L.numSpotMaps=P,L.numLightProbes=A,i.version=bC++)}function l(c,d){let h=0,f=0,m=0,_=0,x=0;const p=d.matrixWorldInverse;for(let u=0,g=c.length;u<g;u++){const v=c[u];if(v.isDirectionalLight){const M=i.directional[h];M.direction.setFromMatrixPosition(v.matrixWorld),r.setFromMatrixPosition(v.target.matrixWorld),M.direction.sub(r),M.direction.transformDirection(p),h++}else if(v.isSpotLight){const M=i.spot[m];M.position.setFromMatrixPosition(v.matrixWorld),M.position.applyMatrix4(p),M.direction.setFromMatrixPosition(v.matrixWorld),r.setFromMatrixPosition(v.target.matrixWorld),M.direction.sub(r),M.direction.transformDirection(p),m++}else if(v.isRectAreaLight){const M=i.rectArea[_];M.position.setFromMatrixPosition(v.matrixWorld),M.position.applyMatrix4(p),a.identity(),s.copy(v.matrixWorld),s.premultiply(p),a.extractRotation(s),M.halfWidth.set(v.width*.5,0,0),M.halfHeight.set(0,v.height*.5,0),M.halfWidth.applyMatrix4(a),M.halfHeight.applyMatrix4(a),_++}else if(v.isPointLight){const M=i.point[f];M.position.setFromMatrixPosition(v.matrixWorld),M.position.applyMatrix4(p),f++}else if(v.isHemisphereLight){const M=i.hemi[x];M.direction.setFromMatrixPosition(v.matrixWorld),M.direction.transformDirection(p),x++}}}return{setup:o,setupView:l,state:i}}function Gm(t){const e=new PC(t),n=[],i=[];function r(d){c.camera=d,n.length=0,i.length=0}function s(d){n.push(d)}function a(d){i.push(d)}function o(){e.setup(n)}function l(d){e.setupView(n,d)}const c={lightsArray:n,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:o,setupLightsView:l,pushLight:s,pushShadow:a}}function LC(t){let e=new WeakMap;function n(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new Gm(t),e.set(r,[o])):s>=a.length?(o=new Gm(t),a.push(o)):o=a[s],o}function i(){e=new WeakMap}return{get:n,dispose:i}}class NC extends Fr{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=RE,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class DC extends Fr{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const IC=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function FC(t,e,n){let i=new ph;const r=new Ge,s=new Ge,a=new Tt,o=new NC({depthPacking:PE}),l=new DC,c={},d=n.maxTextureSize,h={[Ki]:on,[on]:Ki,[qn]:qn},f=new Zi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ge},radius:{value:4}},vertexShader:IC,fragmentShader:UC}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const _=new Gn;_.setAttribute("position",new Jn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new nn(_,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Gv;let u=this.type;this.render=function(C,A,L){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||C.length===0)return;const T=t.getRenderTarget(),y=t.getActiveCubeFace(),N=t.getActiveMipmapLevel(),z=t.state;z.setBlending(Xi),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const G=u!==li&&this.type===li,q=u===li&&this.type!==li;for(let Q=0,I=C.length;Q<I;Q++){const O=C[Q],R=O.shadow;if(R===void 0){console.warn("THREE.WebGLShadowMap:",O,"has no shadow.");continue}if(R.autoUpdate===!1&&R.needsUpdate===!1)continue;r.copy(R.mapSize);const V=R.getFrameExtents();if(r.multiply(V),s.copy(R.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/V.x),r.x=s.x*V.x,R.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/V.y),r.y=s.y*V.y,R.mapSize.y=s.y)),R.map===null||G===!0||q===!0){const te=this.type!==li?{minFilter:An,magFilter:An}:{};R.map!==null&&R.map.dispose(),R.map=new Pr(r.x,r.y,te),R.map.texture.name=O.name+".shadowMap",R.camera.updateProjectionMatrix()}t.setRenderTarget(R.map),t.clear();const Y=R.getViewportCount();for(let te=0;te<Y;te++){const _e=R.getViewport(te);a.set(s.x*_e.x,s.y*_e.y,s.x*_e.z,s.y*_e.w),z.viewport(a),R.updateMatrices(O,te),i=R.getFrustum(),M(A,L,R.camera,O,this.type)}R.isPointLightShadow!==!0&&this.type===li&&g(R,L),R.needsUpdate=!1}u=this.type,p.needsUpdate=!1,t.setRenderTarget(T,y,N)};function g(C,A){const L=e.update(x);f.defines.VSM_SAMPLES!==C.blurSamples&&(f.defines.VSM_SAMPLES=C.blurSamples,m.defines.VSM_SAMPLES=C.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Pr(r.x,r.y)),f.uniforms.shadow_pass.value=C.map.texture,f.uniforms.resolution.value=C.mapSize,f.uniforms.radius.value=C.radius,t.setRenderTarget(C.mapPass),t.clear(),t.renderBufferDirect(A,null,L,f,x,null),m.uniforms.shadow_pass.value=C.mapPass.texture,m.uniforms.resolution.value=C.mapSize,m.uniforms.radius.value=C.radius,t.setRenderTarget(C.map),t.clear(),t.renderBufferDirect(A,null,L,m,x,null)}function v(C,A,L,T){let y=null;const N=L.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(N!==void 0)y=N;else if(y=L.isPointLight===!0?l:o,t.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const z=y.uuid,G=A.uuid;let q=c[z];q===void 0&&(q={},c[z]=q);let Q=q[G];Q===void 0&&(Q=y.clone(),q[G]=Q,A.addEventListener("dispose",P)),y=Q}if(y.visible=A.visible,y.wireframe=A.wireframe,T===li?y.side=A.shadowSide!==null?A.shadowSide:A.side:y.side=A.shadowSide!==null?A.shadowSide:h[A.side],y.alphaMap=A.alphaMap,y.alphaTest=A.alphaTest,y.map=A.map,y.clipShadows=A.clipShadows,y.clippingPlanes=A.clippingPlanes,y.clipIntersection=A.clipIntersection,y.displacementMap=A.displacementMap,y.displacementScale=A.displacementScale,y.displacementBias=A.displacementBias,y.wireframeLinewidth=A.wireframeLinewidth,y.linewidth=A.linewidth,L.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const z=t.properties.get(y);z.light=L}return y}function M(C,A,L,T,y){if(C.visible===!1)return;if(C.layers.test(A.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&y===li)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,C.matrixWorld);const G=e.update(C),q=C.material;if(Array.isArray(q)){const Q=G.groups;for(let I=0,O=Q.length;I<O;I++){const R=Q[I],V=q[R.materialIndex];if(V&&V.visible){const Y=v(C,V,T,y);C.onBeforeShadow(t,C,A,L,G,Y,R),t.renderBufferDirect(L,null,G,Y,C,R),C.onAfterShadow(t,C,A,L,G,Y,R)}}}else if(q.visible){const Q=v(C,q,T,y);C.onBeforeShadow(t,C,A,L,G,Q,null),t.renderBufferDirect(L,null,G,Q,C,null),C.onAfterShadow(t,C,A,L,G,Q,null)}}const z=C.children;for(let G=0,q=z.length;G<q;G++)M(z[G],A,L,T,y)}function P(C){C.target.removeEventListener("dispose",P);for(const L in c){const T=c[L],y=C.target.uuid;y in T&&(T[y].dispose(),delete T[y])}}}function OC(t){function e(){let F=!1;const ue=new Tt;let ee=null;const ne=new Tt(0,0,0,0);return{setMask:function(fe){ee!==fe&&!F&&(t.colorMask(fe,fe,fe,fe),ee=fe)},setLocked:function(fe){F=fe},setClear:function(fe,Ne,$e,xt,Nt){Nt===!0&&(fe*=xt,Ne*=xt,$e*=xt),ue.set(fe,Ne,$e,xt),ne.equals(ue)===!1&&(t.clearColor(fe,Ne,$e,xt),ne.copy(ue))},reset:function(){F=!1,ee=null,ne.set(-1,0,0,0)}}}function n(){let F=!1,ue=null,ee=null,ne=null;return{setTest:function(fe){fe?pe(t.DEPTH_TEST):he(t.DEPTH_TEST)},setMask:function(fe){ue!==fe&&!F&&(t.depthMask(fe),ue=fe)},setFunc:function(fe){if(ee!==fe){switch(fe){case fE:t.depthFunc(t.NEVER);break;case hE:t.depthFunc(t.ALWAYS);break;case pE:t.depthFunc(t.LESS);break;case Fl:t.depthFunc(t.LEQUAL);break;case mE:t.depthFunc(t.EQUAL);break;case gE:t.depthFunc(t.GEQUAL);break;case vE:t.depthFunc(t.GREATER);break;case _E:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ee=fe}},setLocked:function(fe){F=fe},setClear:function(fe){ne!==fe&&(t.clearDepth(fe),ne=fe)},reset:function(){F=!1,ue=null,ee=null,ne=null}}}function i(){let F=!1,ue=null,ee=null,ne=null,fe=null,Ne=null,$e=null,xt=null,Nt=null;return{setTest:function(Ke){F||(Ke?pe(t.STENCIL_TEST):he(t.STENCIL_TEST))},setMask:function(Ke){ue!==Ke&&!F&&(t.stencilMask(Ke),ue=Ke)},setFunc:function(Ke,ti,Wn){(ee!==Ke||ne!==ti||fe!==Wn)&&(t.stencilFunc(Ke,ti,Wn),ee=Ke,ne=ti,fe=Wn)},setOp:function(Ke,ti,Wn){(Ne!==Ke||$e!==ti||xt!==Wn)&&(t.stencilOp(Ke,ti,Wn),Ne=Ke,$e=ti,xt=Wn)},setLocked:function(Ke){F=Ke},setClear:function(Ke){Nt!==Ke&&(t.clearStencil(Ke),Nt=Ke)},reset:function(){F=!1,ue=null,ee=null,ne=null,fe=null,Ne=null,$e=null,xt=null,Nt=null}}}const r=new e,s=new n,a=new i,o=new WeakMap,l=new WeakMap;let c={},d={},h=new WeakMap,f=[],m=null,_=!1,x=null,p=null,u=null,g=null,v=null,M=null,P=null,C=new je(0,0,0),A=0,L=!1,T=null,y=null,N=null,z=null,G=null;const q=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Q=!1,I=0;const O=t.getParameter(t.VERSION);O.indexOf("WebGL")!==-1?(I=parseFloat(/^WebGL (\d)/.exec(O)[1]),Q=I>=1):O.indexOf("OpenGL ES")!==-1&&(I=parseFloat(/^OpenGL ES (\d)/.exec(O)[1]),Q=I>=2);let R=null,V={};const Y=t.getParameter(t.SCISSOR_BOX),te=t.getParameter(t.VIEWPORT),_e=new Tt().fromArray(Y),be=new Tt().fromArray(te);function $(F,ue,ee,ne){const fe=new Uint8Array(4),Ne=t.createTexture();t.bindTexture(F,Ne),t.texParameteri(F,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(F,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let $e=0;$e<ee;$e++)F===t.TEXTURE_3D||F===t.TEXTURE_2D_ARRAY?t.texImage3D(ue,0,t.RGBA,1,1,ne,0,t.RGBA,t.UNSIGNED_BYTE,fe):t.texImage2D(ue+$e,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,fe);return Ne}const ae={};ae[t.TEXTURE_2D]=$(t.TEXTURE_2D,t.TEXTURE_2D,1),ae[t.TEXTURE_CUBE_MAP]=$(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),ae[t.TEXTURE_2D_ARRAY]=$(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),ae[t.TEXTURE_3D]=$(t.TEXTURE_3D,t.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),a.setClear(0),pe(t.DEPTH_TEST),s.setFunc(Fl),K(!1),Z(qp),pe(t.CULL_FACE),ut(Xi);function pe(F){c[F]!==!0&&(t.enable(F),c[F]=!0)}function he(F){c[F]!==!1&&(t.disable(F),c[F]=!1)}function Le(F,ue){return d[F]!==ue?(t.bindFramebuffer(F,ue),d[F]=ue,F===t.DRAW_FRAMEBUFFER&&(d[t.FRAMEBUFFER]=ue),F===t.FRAMEBUFFER&&(d[t.DRAW_FRAMEBUFFER]=ue),!0):!1}function Fe(F,ue){let ee=f,ne=!1;if(F){ee=h.get(ue),ee===void 0&&(ee=[],h.set(ue,ee));const fe=F.textures;if(ee.length!==fe.length||ee[0]!==t.COLOR_ATTACHMENT0){for(let Ne=0,$e=fe.length;Ne<$e;Ne++)ee[Ne]=t.COLOR_ATTACHMENT0+Ne;ee.length=fe.length,ne=!0}}else ee[0]!==t.BACK&&(ee[0]=t.BACK,ne=!0);ne&&t.drawBuffers(ee)}function ke(F){return m!==F?(t.useProgram(F),m=F,!0):!1}const it={[pr]:t.FUNC_ADD,[qM]:t.FUNC_SUBTRACT,[KM]:t.FUNC_REVERSE_SUBTRACT};it[ZM]=t.MIN,it[QM]=t.MAX;const D={[JM]:t.ZERO,[eE]:t.ONE,[tE]:t.SRC_COLOR,[Td]:t.SRC_ALPHA,[oE]:t.SRC_ALPHA_SATURATE,[sE]:t.DST_COLOR,[iE]:t.DST_ALPHA,[nE]:t.ONE_MINUS_SRC_COLOR,[Ad]:t.ONE_MINUS_SRC_ALPHA,[aE]:t.ONE_MINUS_DST_COLOR,[rE]:t.ONE_MINUS_DST_ALPHA,[lE]:t.CONSTANT_COLOR,[cE]:t.ONE_MINUS_CONSTANT_COLOR,[uE]:t.CONSTANT_ALPHA,[dE]:t.ONE_MINUS_CONSTANT_ALPHA};function ut(F,ue,ee,ne,fe,Ne,$e,xt,Nt,Ke){if(F===Xi){_===!0&&(he(t.BLEND),_=!1);return}if(_===!1&&(pe(t.BLEND),_=!0),F!==$M){if(F!==x||Ke!==L){if((p!==pr||v!==pr)&&(t.blendEquation(t.FUNC_ADD),p=pr,v=pr),Ke)switch(F){case Es:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Kp:t.blendFunc(t.ONE,t.ONE);break;case Zp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Qp:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}else switch(F){case Es:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Kp:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case Zp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Qp:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}u=null,g=null,M=null,P=null,C.set(0,0,0),A=0,x=F,L=Ke}return}fe=fe||ue,Ne=Ne||ee,$e=$e||ne,(ue!==p||fe!==v)&&(t.blendEquationSeparate(it[ue],it[fe]),p=ue,v=fe),(ee!==u||ne!==g||Ne!==M||$e!==P)&&(t.blendFuncSeparate(D[ee],D[ne],D[Ne],D[$e]),u=ee,g=ne,M=Ne,P=$e),(xt.equals(C)===!1||Nt!==A)&&(t.blendColor(xt.r,xt.g,xt.b,Nt),C.copy(xt),A=Nt),x=F,L=!1}function Ye(F,ue){F.side===qn?he(t.CULL_FACE):pe(t.CULL_FACE);let ee=F.side===on;ue&&(ee=!ee),K(ee),F.blending===Es&&F.transparent===!1?ut(Xi):ut(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),s.setFunc(F.depthFunc),s.setTest(F.depthTest),s.setMask(F.depthWrite),r.setMask(F.colorWrite);const ne=F.stencilWrite;a.setTest(ne),ne&&(a.setMask(F.stencilWriteMask),a.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),a.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),se(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?pe(t.SAMPLE_ALPHA_TO_COVERAGE):he(t.SAMPLE_ALPHA_TO_COVERAGE)}function K(F){T!==F&&(F?t.frontFace(t.CW):t.frontFace(t.CCW),T=F)}function Z(F){F!==XM?(pe(t.CULL_FACE),F!==y&&(F===qp?t.cullFace(t.BACK):F===YM?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):he(t.CULL_FACE),y=F}function xe(F){F!==N&&(Q&&t.lineWidth(F),N=F)}function se(F,ue,ee){F?(pe(t.POLYGON_OFFSET_FILL),(z!==ue||G!==ee)&&(t.polygonOffset(ue,ee),z=ue,G=ee)):he(t.POLYGON_OFFSET_FILL)}function le(F){F?pe(t.SCISSOR_TEST):he(t.SCISSOR_TEST)}function b(F){F===void 0&&(F=t.TEXTURE0+q-1),R!==F&&(t.activeTexture(F),R=F)}function E(F,ue,ee){ee===void 0&&(R===null?ee=t.TEXTURE0+q-1:ee=R);let ne=V[ee];ne===void 0&&(ne={type:void 0,texture:void 0},V[ee]=ne),(ne.type!==F||ne.texture!==ue)&&(R!==ee&&(t.activeTexture(ee),R=ee),t.bindTexture(F,ue||ae[F]),ne.type=F,ne.texture=ue)}function W(){const F=V[R];F!==void 0&&F.type!==void 0&&(t.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function ie(){try{t.compressedTexImage2D.apply(t,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function re(){try{t.compressedTexImage3D.apply(t,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function J(){try{t.texSubImage2D.apply(t,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Ce(){try{t.texSubImage3D.apply(t,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ge(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Me(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ze(){try{t.texStorage2D.apply(t,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ce(){try{t.texStorage3D.apply(t,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Se(){try{t.texImage2D.apply(t,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Xe(){try{t.texImage3D.apply(t,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Ue(F){_e.equals(F)===!1&&(t.scissor(F.x,F.y,F.z,F.w),_e.copy(F))}function Ee(F){be.equals(F)===!1&&(t.viewport(F.x,F.y,F.z,F.w),be.copy(F))}function Oe(F,ue){let ee=l.get(ue);ee===void 0&&(ee=new WeakMap,l.set(ue,ee));let ne=ee.get(F);ne===void 0&&(ne=t.getUniformBlockIndex(ue,F.name),ee.set(F,ne))}function He(F,ue){const ne=l.get(ue).get(F);o.get(ue)!==ne&&(t.uniformBlockBinding(ue,ne,F.__bindingPointIndex),o.set(ue,ne))}function dt(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),c={},R=null,V={},d={},h=new WeakMap,f=[],m=null,_=!1,x=null,p=null,u=null,g=null,v=null,M=null,P=null,C=new je(0,0,0),A=0,L=!1,T=null,y=null,N=null,z=null,G=null,_e.set(0,0,t.canvas.width,t.canvas.height),be.set(0,0,t.canvas.width,t.canvas.height),r.reset(),s.reset(),a.reset()}return{buffers:{color:r,depth:s,stencil:a},enable:pe,disable:he,bindFramebuffer:Le,drawBuffers:Fe,useProgram:ke,setBlending:ut,setMaterial:Ye,setFlipSided:K,setCullFace:Z,setLineWidth:xe,setPolygonOffset:se,setScissorTest:le,activeTexture:b,bindTexture:E,unbindTexture:W,compressedTexImage2D:ie,compressedTexImage3D:re,texImage2D:Se,texImage3D:Xe,updateUBOMapping:Oe,uniformBlockBinding:He,texStorage2D:ze,texStorage3D:ce,texSubImage2D:J,texSubImage3D:Ce,compressedTexSubImage2D:ge,compressedTexSubImage3D:Me,scissor:Ue,viewport:Ee,reset:dt}}function Wm(t,e,n,i){const r=kC(i);switch(n){case Kv:return t*e;case Qv:return t*e;case Jv:return t*e*2;case e_:return t*e/r.components*r.byteLength;case oh:return t*e/r.components*r.byteLength;case t_:return t*e*2/r.components*r.byteLength;case lh:return t*e*2/r.components*r.byteLength;case Zv:return t*e*3/r.components*r.byteLength;case zn:return t*e*4/r.components*r.byteLength;case ch:return t*e*4/r.components*r.byteLength;case sl:case al:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case ol:case ll:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Nd:case Id:return Math.max(t,16)*Math.max(e,8)/4;case Ld:case Dd:return Math.max(t,8)*Math.max(e,8)/2;case Ud:case Fd:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case Od:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case kd:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case zd:return Math.floor((t+4)/5)*Math.floor((e+3)/4)*16;case Bd:return Math.floor((t+4)/5)*Math.floor((e+4)/5)*16;case Vd:return Math.floor((t+5)/6)*Math.floor((e+4)/5)*16;case Hd:return Math.floor((t+5)/6)*Math.floor((e+5)/6)*16;case Gd:return Math.floor((t+7)/8)*Math.floor((e+4)/5)*16;case Wd:return Math.floor((t+7)/8)*Math.floor((e+5)/6)*16;case jd:return Math.floor((t+7)/8)*Math.floor((e+7)/8)*16;case Xd:return Math.floor((t+9)/10)*Math.floor((e+4)/5)*16;case Yd:return Math.floor((t+9)/10)*Math.floor((e+5)/6)*16;case $d:return Math.floor((t+9)/10)*Math.floor((e+7)/8)*16;case qd:return Math.floor((t+9)/10)*Math.floor((e+9)/10)*16;case Kd:return Math.floor((t+11)/12)*Math.floor((e+9)/10)*16;case Zd:return Math.floor((t+11)/12)*Math.floor((e+11)/12)*16;case cl:case Qd:case Jd:return Math.ceil(t/4)*Math.ceil(e/4)*16;case n_:case ef:return Math.ceil(t/4)*Math.ceil(e/4)*8;case tf:case nf:return Math.ceil(t/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function kC(t){switch(t){case yi:case Yv:return{byteLength:1,components:1};case Ga:case $v:case Za:return{byteLength:2,components:1};case sh:case ah:return{byteLength:2,components:4};case Rr:case rh:case hi:return{byteLength:4,components:1};case qv:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${t}.`)}function zC(t,e,n,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ge,d=new WeakMap;let h;const f=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(b,E){return m?new OffscreenCanvas(b,E):Vl("canvas")}function x(b,E,W){let ie=1;const re=le(b);if((re.width>W||re.height>W)&&(ie=W/Math.max(re.width,re.height)),ie<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const J=Math.floor(ie*re.width),Ce=Math.floor(ie*re.height);h===void 0&&(h=_(J,Ce));const ge=E?_(J,Ce):h;return ge.width=J,ge.height=Ce,ge.getContext("2d").drawImage(b,0,0,J,Ce),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+re.width+"x"+re.height+") to ("+J+"x"+Ce+")."),ge}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+re.width+"x"+re.height+")."),b;return b}function p(b){return b.generateMipmaps&&b.minFilter!==An&&b.minFilter!==kn}function u(b){t.generateMipmap(b)}function g(b,E,W,ie,re=!1){if(b!==null){if(t[b]!==void 0)return t[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let J=E;if(E===t.RED&&(W===t.FLOAT&&(J=t.R32F),W===t.HALF_FLOAT&&(J=t.R16F),W===t.UNSIGNED_BYTE&&(J=t.R8)),E===t.RED_INTEGER&&(W===t.UNSIGNED_BYTE&&(J=t.R8UI),W===t.UNSIGNED_SHORT&&(J=t.R16UI),W===t.UNSIGNED_INT&&(J=t.R32UI),W===t.BYTE&&(J=t.R8I),W===t.SHORT&&(J=t.R16I),W===t.INT&&(J=t.R32I)),E===t.RG&&(W===t.FLOAT&&(J=t.RG32F),W===t.HALF_FLOAT&&(J=t.RG16F),W===t.UNSIGNED_BYTE&&(J=t.RG8)),E===t.RG_INTEGER&&(W===t.UNSIGNED_BYTE&&(J=t.RG8UI),W===t.UNSIGNED_SHORT&&(J=t.RG16UI),W===t.UNSIGNED_INT&&(J=t.RG32UI),W===t.BYTE&&(J=t.RG8I),W===t.SHORT&&(J=t.RG16I),W===t.INT&&(J=t.RG32I)),E===t.RGB&&W===t.UNSIGNED_INT_5_9_9_9_REV&&(J=t.RGB9_E5),E===t.RGBA){const Ce=re?Ol:et.getTransfer(ie);W===t.FLOAT&&(J=t.RGBA32F),W===t.HALF_FLOAT&&(J=t.RGBA16F),W===t.UNSIGNED_BYTE&&(J=Ce===at?t.SRGB8_ALPHA8:t.RGBA8),W===t.UNSIGNED_SHORT_4_4_4_4&&(J=t.RGBA4),W===t.UNSIGNED_SHORT_5_5_5_1&&(J=t.RGB5_A1)}return(J===t.R16F||J===t.R32F||J===t.RG16F||J===t.RG32F||J===t.RGBA16F||J===t.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function v(b,E){let W;return b?E===null||E===Rr||E===Fs?W=t.DEPTH24_STENCIL8:E===hi?W=t.DEPTH32F_STENCIL8:E===Ga&&(W=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Rr||E===Fs?W=t.DEPTH_COMPONENT24:E===hi?W=t.DEPTH_COMPONENT32F:E===Ga&&(W=t.DEPTH_COMPONENT16),W}function M(b,E){return p(b)===!0||b.isFramebufferTexture&&b.minFilter!==An&&b.minFilter!==kn?Math.log2(Math.max(E.width,E.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?E.mipmaps.length:1}function P(b){const E=b.target;E.removeEventListener("dispose",P),A(E),E.isVideoTexture&&d.delete(E)}function C(b){const E=b.target;E.removeEventListener("dispose",C),T(E)}function A(b){const E=i.get(b);if(E.__webglInit===void 0)return;const W=b.source,ie=f.get(W);if(ie){const re=ie[E.__cacheKey];re.usedTimes--,re.usedTimes===0&&L(b),Object.keys(ie).length===0&&f.delete(W)}i.remove(b)}function L(b){const E=i.get(b);t.deleteTexture(E.__webglTexture);const W=b.source,ie=f.get(W);delete ie[E.__cacheKey],a.memory.textures--}function T(b){const E=i.get(b);if(b.depthTexture&&b.depthTexture.dispose(),b.isWebGLCubeRenderTarget)for(let ie=0;ie<6;ie++){if(Array.isArray(E.__webglFramebuffer[ie]))for(let re=0;re<E.__webglFramebuffer[ie].length;re++)t.deleteFramebuffer(E.__webglFramebuffer[ie][re]);else t.deleteFramebuffer(E.__webglFramebuffer[ie]);E.__webglDepthbuffer&&t.deleteRenderbuffer(E.__webglDepthbuffer[ie])}else{if(Array.isArray(E.__webglFramebuffer))for(let ie=0;ie<E.__webglFramebuffer.length;ie++)t.deleteFramebuffer(E.__webglFramebuffer[ie]);else t.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&t.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&t.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let ie=0;ie<E.__webglColorRenderbuffer.length;ie++)E.__webglColorRenderbuffer[ie]&&t.deleteRenderbuffer(E.__webglColorRenderbuffer[ie]);E.__webglDepthRenderbuffer&&t.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const W=b.textures;for(let ie=0,re=W.length;ie<re;ie++){const J=i.get(W[ie]);J.__webglTexture&&(t.deleteTexture(J.__webglTexture),a.memory.textures--),i.remove(W[ie])}i.remove(b)}let y=0;function N(){y=0}function z(){const b=y;return b>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),y+=1,b}function G(b){const E=[];return E.push(b.wrapS),E.push(b.wrapT),E.push(b.wrapR||0),E.push(b.magFilter),E.push(b.minFilter),E.push(b.anisotropy),E.push(b.internalFormat),E.push(b.format),E.push(b.type),E.push(b.generateMipmaps),E.push(b.premultiplyAlpha),E.push(b.flipY),E.push(b.unpackAlignment),E.push(b.colorSpace),E.join()}function q(b,E){const W=i.get(b);if(b.isVideoTexture&&xe(b),b.isRenderTargetTexture===!1&&b.version>0&&W.__version!==b.version){const ie=b.image;if(ie===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ie.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{be(W,b,E);return}}n.bindTexture(t.TEXTURE_2D,W.__webglTexture,t.TEXTURE0+E)}function Q(b,E){const W=i.get(b);if(b.version>0&&W.__version!==b.version){be(W,b,E);return}n.bindTexture(t.TEXTURE_2D_ARRAY,W.__webglTexture,t.TEXTURE0+E)}function I(b,E){const W=i.get(b);if(b.version>0&&W.__version!==b.version){be(W,b,E);return}n.bindTexture(t.TEXTURE_3D,W.__webglTexture,t.TEXTURE0+E)}function O(b,E){const W=i.get(b);if(b.version>0&&W.__version!==b.version){$(W,b,E);return}n.bindTexture(t.TEXTURE_CUBE_MAP,W.__webglTexture,t.TEXTURE0+E)}const R={[Rd]:t.REPEAT,[xr]:t.CLAMP_TO_EDGE,[Pd]:t.MIRRORED_REPEAT},V={[An]:t.NEAREST,[bE]:t.NEAREST_MIPMAP_NEAREST,[Eo]:t.NEAREST_MIPMAP_LINEAR,[kn]:t.LINEAR,[qc]:t.LINEAR_MIPMAP_NEAREST,[yr]:t.LINEAR_MIPMAP_LINEAR},Y={[NE]:t.NEVER,[kE]:t.ALWAYS,[DE]:t.LESS,[r_]:t.LEQUAL,[IE]:t.EQUAL,[OE]:t.GEQUAL,[UE]:t.GREATER,[FE]:t.NOTEQUAL};function te(b,E){if(E.type===hi&&e.has("OES_texture_float_linear")===!1&&(E.magFilter===kn||E.magFilter===qc||E.magFilter===Eo||E.magFilter===yr||E.minFilter===kn||E.minFilter===qc||E.minFilter===Eo||E.minFilter===yr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(b,t.TEXTURE_WRAP_S,R[E.wrapS]),t.texParameteri(b,t.TEXTURE_WRAP_T,R[E.wrapT]),(b===t.TEXTURE_3D||b===t.TEXTURE_2D_ARRAY)&&t.texParameteri(b,t.TEXTURE_WRAP_R,R[E.wrapR]),t.texParameteri(b,t.TEXTURE_MAG_FILTER,V[E.magFilter]),t.texParameteri(b,t.TEXTURE_MIN_FILTER,V[E.minFilter]),E.compareFunction&&(t.texParameteri(b,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(b,t.TEXTURE_COMPARE_FUNC,Y[E.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===An||E.minFilter!==Eo&&E.minFilter!==yr||E.type===hi&&e.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||i.get(E).__currentAnisotropy){const W=e.get("EXT_texture_filter_anisotropic");t.texParameterf(b,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,r.getMaxAnisotropy())),i.get(E).__currentAnisotropy=E.anisotropy}}}function _e(b,E){let W=!1;b.__webglInit===void 0&&(b.__webglInit=!0,E.addEventListener("dispose",P));const ie=E.source;let re=f.get(ie);re===void 0&&(re={},f.set(ie,re));const J=G(E);if(J!==b.__cacheKey){re[J]===void 0&&(re[J]={texture:t.createTexture(),usedTimes:0},a.memory.textures++,W=!0),re[J].usedTimes++;const Ce=re[b.__cacheKey];Ce!==void 0&&(re[b.__cacheKey].usedTimes--,Ce.usedTimes===0&&L(E)),b.__cacheKey=J,b.__webglTexture=re[J].texture}return W}function be(b,E,W){let ie=t.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(ie=t.TEXTURE_2D_ARRAY),E.isData3DTexture&&(ie=t.TEXTURE_3D);const re=_e(b,E),J=E.source;n.bindTexture(ie,b.__webglTexture,t.TEXTURE0+W);const Ce=i.get(J);if(J.version!==Ce.__version||re===!0){n.activeTexture(t.TEXTURE0+W);const ge=et.getPrimaries(et.workingColorSpace),Me=E.colorSpace===Ii?null:et.getPrimaries(E.colorSpace),ze=E.colorSpace===Ii||ge===Me?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,E.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,E.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ze);let ce=x(E.image,!1,r.maxTextureSize);ce=se(E,ce);const Se=s.convert(E.format,E.colorSpace),Xe=s.convert(E.type);let Ue=g(E.internalFormat,Se,Xe,E.colorSpace,E.isVideoTexture);te(ie,E);let Ee;const Oe=E.mipmaps,He=E.isVideoTexture!==!0,dt=Ce.__version===void 0||re===!0,F=J.dataReady,ue=M(E,ce);if(E.isDepthTexture)Ue=v(E.format===Os,E.type),dt&&(He?n.texStorage2D(t.TEXTURE_2D,1,Ue,ce.width,ce.height):n.texImage2D(t.TEXTURE_2D,0,Ue,ce.width,ce.height,0,Se,Xe,null));else if(E.isDataTexture)if(Oe.length>0){He&&dt&&n.texStorage2D(t.TEXTURE_2D,ue,Ue,Oe[0].width,Oe[0].height);for(let ee=0,ne=Oe.length;ee<ne;ee++)Ee=Oe[ee],He?F&&n.texSubImage2D(t.TEXTURE_2D,ee,0,0,Ee.width,Ee.height,Se,Xe,Ee.data):n.texImage2D(t.TEXTURE_2D,ee,Ue,Ee.width,Ee.height,0,Se,Xe,Ee.data);E.generateMipmaps=!1}else He?(dt&&n.texStorage2D(t.TEXTURE_2D,ue,Ue,ce.width,ce.height),F&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ce.width,ce.height,Se,Xe,ce.data)):n.texImage2D(t.TEXTURE_2D,0,Ue,ce.width,ce.height,0,Se,Xe,ce.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){He&&dt&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ue,Ue,Oe[0].width,Oe[0].height,ce.depth);for(let ee=0,ne=Oe.length;ee<ne;ee++)if(Ee=Oe[ee],E.format!==zn)if(Se!==null)if(He){if(F)if(E.layerUpdates.size>0){const fe=Wm(Ee.width,Ee.height,E.format,E.type);for(const Ne of E.layerUpdates){const $e=Ee.data.subarray(Ne*fe/Ee.data.BYTES_PER_ELEMENT,(Ne+1)*fe/Ee.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ee,0,0,Ne,Ee.width,Ee.height,1,Se,$e,0,0)}E.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ee,0,0,0,Ee.width,Ee.height,ce.depth,Se,Ee.data,0,0)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,ee,Ue,Ee.width,Ee.height,ce.depth,0,Ee.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else He?F&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,ee,0,0,0,Ee.width,Ee.height,ce.depth,Se,Xe,Ee.data):n.texImage3D(t.TEXTURE_2D_ARRAY,ee,Ue,Ee.width,Ee.height,ce.depth,0,Se,Xe,Ee.data)}else{He&&dt&&n.texStorage2D(t.TEXTURE_2D,ue,Ue,Oe[0].width,Oe[0].height);for(let ee=0,ne=Oe.length;ee<ne;ee++)Ee=Oe[ee],E.format!==zn?Se!==null?He?F&&n.compressedTexSubImage2D(t.TEXTURE_2D,ee,0,0,Ee.width,Ee.height,Se,Ee.data):n.compressedTexImage2D(t.TEXTURE_2D,ee,Ue,Ee.width,Ee.height,0,Ee.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):He?F&&n.texSubImage2D(t.TEXTURE_2D,ee,0,0,Ee.width,Ee.height,Se,Xe,Ee.data):n.texImage2D(t.TEXTURE_2D,ee,Ue,Ee.width,Ee.height,0,Se,Xe,Ee.data)}else if(E.isDataArrayTexture)if(He){if(dt&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ue,Ue,ce.width,ce.height,ce.depth),F)if(E.layerUpdates.size>0){const ee=Wm(ce.width,ce.height,E.format,E.type);for(const ne of E.layerUpdates){const fe=ce.data.subarray(ne*ee/ce.data.BYTES_PER_ELEMENT,(ne+1)*ee/ce.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,ne,ce.width,ce.height,1,Se,Xe,fe)}E.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,ce.width,ce.height,ce.depth,Se,Xe,ce.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,Ue,ce.width,ce.height,ce.depth,0,Se,Xe,ce.data);else if(E.isData3DTexture)He?(dt&&n.texStorage3D(t.TEXTURE_3D,ue,Ue,ce.width,ce.height,ce.depth),F&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,ce.width,ce.height,ce.depth,Se,Xe,ce.data)):n.texImage3D(t.TEXTURE_3D,0,Ue,ce.width,ce.height,ce.depth,0,Se,Xe,ce.data);else if(E.isFramebufferTexture){if(dt)if(He)n.texStorage2D(t.TEXTURE_2D,ue,Ue,ce.width,ce.height);else{let ee=ce.width,ne=ce.height;for(let fe=0;fe<ue;fe++)n.texImage2D(t.TEXTURE_2D,fe,Ue,ee,ne,0,Se,Xe,null),ee>>=1,ne>>=1}}else if(Oe.length>0){if(He&&dt){const ee=le(Oe[0]);n.texStorage2D(t.TEXTURE_2D,ue,Ue,ee.width,ee.height)}for(let ee=0,ne=Oe.length;ee<ne;ee++)Ee=Oe[ee],He?F&&n.texSubImage2D(t.TEXTURE_2D,ee,0,0,Se,Xe,Ee):n.texImage2D(t.TEXTURE_2D,ee,Ue,Se,Xe,Ee);E.generateMipmaps=!1}else if(He){if(dt){const ee=le(ce);n.texStorage2D(t.TEXTURE_2D,ue,Ue,ee.width,ee.height)}F&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,Se,Xe,ce)}else n.texImage2D(t.TEXTURE_2D,0,Ue,Se,Xe,ce);p(E)&&u(ie),Ce.__version=J.version,E.onUpdate&&E.onUpdate(E)}b.__version=E.version}function $(b,E,W){if(E.image.length!==6)return;const ie=_e(b,E),re=E.source;n.bindTexture(t.TEXTURE_CUBE_MAP,b.__webglTexture,t.TEXTURE0+W);const J=i.get(re);if(re.version!==J.__version||ie===!0){n.activeTexture(t.TEXTURE0+W);const Ce=et.getPrimaries(et.workingColorSpace),ge=E.colorSpace===Ii?null:et.getPrimaries(E.colorSpace),Me=E.colorSpace===Ii||Ce===ge?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,E.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,E.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Me);const ze=E.isCompressedTexture||E.image[0].isCompressedTexture,ce=E.image[0]&&E.image[0].isDataTexture,Se=[];for(let ne=0;ne<6;ne++)!ze&&!ce?Se[ne]=x(E.image[ne],!0,r.maxCubemapSize):Se[ne]=ce?E.image[ne].image:E.image[ne],Se[ne]=se(E,Se[ne]);const Xe=Se[0],Ue=s.convert(E.format,E.colorSpace),Ee=s.convert(E.type),Oe=g(E.internalFormat,Ue,Ee,E.colorSpace),He=E.isVideoTexture!==!0,dt=J.__version===void 0||ie===!0,F=re.dataReady;let ue=M(E,Xe);te(t.TEXTURE_CUBE_MAP,E);let ee;if(ze){He&&dt&&n.texStorage2D(t.TEXTURE_CUBE_MAP,ue,Oe,Xe.width,Xe.height);for(let ne=0;ne<6;ne++){ee=Se[ne].mipmaps;for(let fe=0;fe<ee.length;fe++){const Ne=ee[fe];E.format!==zn?Ue!==null?He?F&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,fe,0,0,Ne.width,Ne.height,Ue,Ne.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,fe,Oe,Ne.width,Ne.height,0,Ne.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):He?F&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,fe,0,0,Ne.width,Ne.height,Ue,Ee,Ne.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,fe,Oe,Ne.width,Ne.height,0,Ue,Ee,Ne.data)}}}else{if(ee=E.mipmaps,He&&dt){ee.length>0&&ue++;const ne=le(Se[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,ue,Oe,ne.width,ne.height)}for(let ne=0;ne<6;ne++)if(ce){He?F&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,Se[ne].width,Se[ne].height,Ue,Ee,Se[ne].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,Oe,Se[ne].width,Se[ne].height,0,Ue,Ee,Se[ne].data);for(let fe=0;fe<ee.length;fe++){const $e=ee[fe].image[ne].image;He?F&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,fe+1,0,0,$e.width,$e.height,Ue,Ee,$e.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,fe+1,Oe,$e.width,$e.height,0,Ue,Ee,$e.data)}}else{He?F&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,Ue,Ee,Se[ne]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,Oe,Ue,Ee,Se[ne]);for(let fe=0;fe<ee.length;fe++){const Ne=ee[fe];He?F&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,fe+1,0,0,Ue,Ee,Ne.image[ne]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,fe+1,Oe,Ue,Ee,Ne.image[ne])}}}p(E)&&u(t.TEXTURE_CUBE_MAP),J.__version=re.version,E.onUpdate&&E.onUpdate(E)}b.__version=E.version}function ae(b,E,W,ie,re,J){const Ce=s.convert(W.format,W.colorSpace),ge=s.convert(W.type),Me=g(W.internalFormat,Ce,ge,W.colorSpace);if(!i.get(E).__hasExternalTextures){const ce=Math.max(1,E.width>>J),Se=Math.max(1,E.height>>J);re===t.TEXTURE_3D||re===t.TEXTURE_2D_ARRAY?n.texImage3D(re,J,Me,ce,Se,E.depth,0,Ce,ge,null):n.texImage2D(re,J,Me,ce,Se,0,Ce,ge,null)}n.bindFramebuffer(t.FRAMEBUFFER,b),Z(E)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ie,re,i.get(W).__webglTexture,0,K(E)):(re===t.TEXTURE_2D||re>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&re<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,ie,re,i.get(W).__webglTexture,J),n.bindFramebuffer(t.FRAMEBUFFER,null)}function pe(b,E,W){if(t.bindRenderbuffer(t.RENDERBUFFER,b),E.depthBuffer){const ie=E.depthTexture,re=ie&&ie.isDepthTexture?ie.type:null,J=v(E.stencilBuffer,re),Ce=E.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ge=K(E);Z(E)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ge,J,E.width,E.height):W?t.renderbufferStorageMultisample(t.RENDERBUFFER,ge,J,E.width,E.height):t.renderbufferStorage(t.RENDERBUFFER,J,E.width,E.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Ce,t.RENDERBUFFER,b)}else{const ie=E.textures;for(let re=0;re<ie.length;re++){const J=ie[re],Ce=s.convert(J.format,J.colorSpace),ge=s.convert(J.type),Me=g(J.internalFormat,Ce,ge,J.colorSpace),ze=K(E);W&&Z(E)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,ze,Me,E.width,E.height):Z(E)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ze,Me,E.width,E.height):t.renderbufferStorage(t.RENDERBUFFER,Me,E.width,E.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function he(b,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,b),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(E.depthTexture).__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),q(E.depthTexture,0);const ie=i.get(E.depthTexture).__webglTexture,re=K(E);if(E.depthTexture.format===ws)Z(E)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ie,0,re):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ie,0);else if(E.depthTexture.format===Os)Z(E)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ie,0,re):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ie,0);else throw new Error("Unknown depthTexture format")}function Le(b){const E=i.get(b),W=b.isWebGLCubeRenderTarget===!0;if(b.depthTexture&&!E.__autoAllocateDepthBuffer){if(W)throw new Error("target.depthTexture not supported in Cube render targets");he(E.__webglFramebuffer,b)}else if(W){E.__webglDepthbuffer=[];for(let ie=0;ie<6;ie++)n.bindFramebuffer(t.FRAMEBUFFER,E.__webglFramebuffer[ie]),E.__webglDepthbuffer[ie]=t.createRenderbuffer(),pe(E.__webglDepthbuffer[ie],b,!1)}else n.bindFramebuffer(t.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer=t.createRenderbuffer(),pe(E.__webglDepthbuffer,b,!1);n.bindFramebuffer(t.FRAMEBUFFER,null)}function Fe(b,E,W){const ie=i.get(b);E!==void 0&&ae(ie.__webglFramebuffer,b,b.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),W!==void 0&&Le(b)}function ke(b){const E=b.texture,W=i.get(b),ie=i.get(E);b.addEventListener("dispose",C);const re=b.textures,J=b.isWebGLCubeRenderTarget===!0,Ce=re.length>1;if(Ce||(ie.__webglTexture===void 0&&(ie.__webglTexture=t.createTexture()),ie.__version=E.version,a.memory.textures++),J){W.__webglFramebuffer=[];for(let ge=0;ge<6;ge++)if(E.mipmaps&&E.mipmaps.length>0){W.__webglFramebuffer[ge]=[];for(let Me=0;Me<E.mipmaps.length;Me++)W.__webglFramebuffer[ge][Me]=t.createFramebuffer()}else W.__webglFramebuffer[ge]=t.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){W.__webglFramebuffer=[];for(let ge=0;ge<E.mipmaps.length;ge++)W.__webglFramebuffer[ge]=t.createFramebuffer()}else W.__webglFramebuffer=t.createFramebuffer();if(Ce)for(let ge=0,Me=re.length;ge<Me;ge++){const ze=i.get(re[ge]);ze.__webglTexture===void 0&&(ze.__webglTexture=t.createTexture(),a.memory.textures++)}if(b.samples>0&&Z(b)===!1){W.__webglMultisampledFramebuffer=t.createFramebuffer(),W.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,W.__webglMultisampledFramebuffer);for(let ge=0;ge<re.length;ge++){const Me=re[ge];W.__webglColorRenderbuffer[ge]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,W.__webglColorRenderbuffer[ge]);const ze=s.convert(Me.format,Me.colorSpace),ce=s.convert(Me.type),Se=g(Me.internalFormat,ze,ce,Me.colorSpace,b.isXRRenderTarget===!0),Xe=K(b);t.renderbufferStorageMultisample(t.RENDERBUFFER,Xe,Se,b.width,b.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ge,t.RENDERBUFFER,W.__webglColorRenderbuffer[ge])}t.bindRenderbuffer(t.RENDERBUFFER,null),b.depthBuffer&&(W.__webglDepthRenderbuffer=t.createRenderbuffer(),pe(W.__webglDepthRenderbuffer,b,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(J){n.bindTexture(t.TEXTURE_CUBE_MAP,ie.__webglTexture),te(t.TEXTURE_CUBE_MAP,E);for(let ge=0;ge<6;ge++)if(E.mipmaps&&E.mipmaps.length>0)for(let Me=0;Me<E.mipmaps.length;Me++)ae(W.__webglFramebuffer[ge][Me],b,E,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,Me);else ae(W.__webglFramebuffer[ge],b,E,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0);p(E)&&u(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Ce){for(let ge=0,Me=re.length;ge<Me;ge++){const ze=re[ge],ce=i.get(ze);n.bindTexture(t.TEXTURE_2D,ce.__webglTexture),te(t.TEXTURE_2D,ze),ae(W.__webglFramebuffer,b,ze,t.COLOR_ATTACHMENT0+ge,t.TEXTURE_2D,0),p(ze)&&u(t.TEXTURE_2D)}n.unbindTexture()}else{let ge=t.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(ge=b.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ge,ie.__webglTexture),te(ge,E),E.mipmaps&&E.mipmaps.length>0)for(let Me=0;Me<E.mipmaps.length;Me++)ae(W.__webglFramebuffer[Me],b,E,t.COLOR_ATTACHMENT0,ge,Me);else ae(W.__webglFramebuffer,b,E,t.COLOR_ATTACHMENT0,ge,0);p(E)&&u(ge),n.unbindTexture()}b.depthBuffer&&Le(b)}function it(b){const E=b.textures;for(let W=0,ie=E.length;W<ie;W++){const re=E[W];if(p(re)){const J=b.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:t.TEXTURE_2D,Ce=i.get(re).__webglTexture;n.bindTexture(J,Ce),u(J),n.unbindTexture()}}}const D=[],ut=[];function Ye(b){if(b.samples>0){if(Z(b)===!1){const E=b.textures,W=b.width,ie=b.height;let re=t.COLOR_BUFFER_BIT;const J=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Ce=i.get(b),ge=E.length>1;if(ge)for(let Me=0;Me<E.length;Me++)n.bindFramebuffer(t.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Me,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Ce.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Me,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer);for(let Me=0;Me<E.length;Me++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(re|=t.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(re|=t.STENCIL_BUFFER_BIT)),ge){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Ce.__webglColorRenderbuffer[Me]);const ze=i.get(E[Me]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,ze,0)}t.blitFramebuffer(0,0,W,ie,0,0,W,ie,re,t.NEAREST),l===!0&&(D.length=0,ut.length=0,D.push(t.COLOR_ATTACHMENT0+Me),b.depthBuffer&&b.resolveDepthBuffer===!1&&(D.push(J),ut.push(J),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,ut)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,D))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ge)for(let Me=0;Me<E.length;Me++){n.bindFramebuffer(t.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Me,t.RENDERBUFFER,Ce.__webglColorRenderbuffer[Me]);const ze=i.get(E[Me]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Ce.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Me,t.TEXTURE_2D,ze,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const E=b.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[E])}}}function K(b){return Math.min(r.maxSamples,b.samples)}function Z(b){const E=i.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function xe(b){const E=a.render.frame;d.get(b)!==E&&(d.set(b,E),b.update())}function se(b,E){const W=b.colorSpace,ie=b.format,re=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||W!==tr&&W!==Ii&&(et.getTransfer(W)===at?(ie!==zn||re!==yi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",W)),E}function le(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=N,this.setTexture2D=q,this.setTexture2DArray=Q,this.setTexture3D=I,this.setTextureCube=O,this.rebindTextures=Fe,this.setupRenderTarget=ke,this.updateRenderTargetMipmap=it,this.updateMultisampleRenderTarget=Ye,this.setupDepthRenderbuffer=Le,this.setupFrameBufferTexture=ae,this.useMultisampledRTT=Z}function BC(t,e){function n(i,r=Ii){let s;const a=et.getTransfer(r);if(i===yi)return t.UNSIGNED_BYTE;if(i===sh)return t.UNSIGNED_SHORT_4_4_4_4;if(i===ah)return t.UNSIGNED_SHORT_5_5_5_1;if(i===qv)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===Yv)return t.BYTE;if(i===$v)return t.SHORT;if(i===Ga)return t.UNSIGNED_SHORT;if(i===rh)return t.INT;if(i===Rr)return t.UNSIGNED_INT;if(i===hi)return t.FLOAT;if(i===Za)return t.HALF_FLOAT;if(i===Kv)return t.ALPHA;if(i===Zv)return t.RGB;if(i===zn)return t.RGBA;if(i===Qv)return t.LUMINANCE;if(i===Jv)return t.LUMINANCE_ALPHA;if(i===ws)return t.DEPTH_COMPONENT;if(i===Os)return t.DEPTH_STENCIL;if(i===e_)return t.RED;if(i===oh)return t.RED_INTEGER;if(i===t_)return t.RG;if(i===lh)return t.RG_INTEGER;if(i===ch)return t.RGBA_INTEGER;if(i===sl||i===al||i===ol||i===ll)if(a===at)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===sl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===al)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ol)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ll)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===sl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===al)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ol)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ll)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Ld||i===Nd||i===Dd||i===Id)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Ld)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Nd)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Dd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Id)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Ud||i===Fd||i===Od)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Ud||i===Fd)return a===at?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Od)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===kd||i===zd||i===Bd||i===Vd||i===Hd||i===Gd||i===Wd||i===jd||i===Xd||i===Yd||i===$d||i===qd||i===Kd||i===Zd)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===kd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===zd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Bd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Vd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Hd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Gd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Wd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===jd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Xd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Yd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===$d)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===qd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Kd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Zd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===cl||i===Qd||i===Jd)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===cl)return a===at?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Qd)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Jd)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===n_||i===ef||i===tf||i===nf)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===cl)return s.COMPRESSED_RED_RGTC1_EXT;if(i===ef)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===tf)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===nf)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Fs?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}class VC extends pn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Ft extends kt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const HC={type:"move"};class Mu{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ft,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ft,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new H,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new H),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ft,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new H,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new H),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const x of e.hand.values()){const p=n.getJointPose(x,i),u=this._getHandJoint(c,x);p!==null&&(u.matrix.fromArray(p.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=p.radius),u.visible=p!==null}const d=c.joints["index-finger-tip"],h=c.joints["thumb-tip"],f=d.position.distanceTo(h.position),m=.02,_=.005;c.inputState.pinching&&f>m+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&f<=m-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=n.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(HC)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new Ft;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}const GC=`
void main() {
...
}`;class jC{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,i){if(this.texture===null){const r=new ln,s=e.properties.get(r);s.__webglTexture=n.texture,(n.depthNear!=i.depthNear||n.depthFar!=i.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new Zi({vertexShader:GC,fragmentShader:WC,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new nn(new eo(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class XC extends Gs{constructor(e,n){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,d=null,h=null,f=null,m=null,_=null;const x=new jC,p=n.getContextAttributes();let u=null,g=null;const v=[],M=[],P=new Ge;let C=null;const A=new pn;A.layers.enable(1),A.viewport=new Tt;const L=new pn;L.layers.enable(2),L.viewport=new Tt;const T=[A,L],y=new VC;y.layers.enable(1),y.layers.enable(2);let N=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let ae=v[$];return ae===void 0&&(ae=new Mu,v[$]=ae),ae.getTargetRaySpace()},this.getControllerGrip=function($){let ae=v[$];return ae===void 0&&(ae=new Mu,v[$]=ae),ae.getGripSpace()},this.getHand=function($){let ae=v[$];return ae===void 0&&(ae=new Mu,v[$]=ae),ae.getHandSpace()};function G($){const ae=M.indexOf($.inputSource);if(ae===-1)return;const pe=v[ae];pe!==void 0&&(pe.update($.inputSource,$.frame,c||a),pe.dispatchEvent({type:$.type,data:$.inputSource}))}function q(){r.removeEventListener("select",G),r.removeEventListener("selectstart",G),r.removeEventListener("selectend",G),r.removeEventListener("squeeze",G),r.removeEventListener("squeezestart",G),r.removeEventListener("squeezeend",G),r.removeEventListener("end",q),r.removeEventListener("inputsourceschange",Q);for(let $=0;$<v.length;$++){const ae=M[$];ae!==null&&(M[$]=null,v[$].disconnect(ae))}N=null,z=null,x.reset(),e.setRenderTarget(u),m=null,f=null,h=null,r=null,g=null,be.stop(),i.isPresenting=!1,e.setPixelRatio(C),e.setSize(P.width,P.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){s=$,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){o=$,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function($){c=$},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return h},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function($){if(r=$,r!==null){if(u=e.getRenderTarget(),r.addEventListener("select",G),r.addEventListener("selectstart",G),r.addEventListener("selectend",G),r.addEventListener("squeeze",G),r.addEventListener("squeezestart",G),r.addEventListener("squeezeend",G),r.addEventListener("end",q),r.addEventListener("inputsourceschange",Q),p.xrCompatible!==!0&&await n.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(P),r.renderState.layers===void 0){const ae={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,n,ae),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),g=new Pr(m.framebufferWidth,m.framebufferHeight,{format:zn,type:yi,colorSpace:e.outputColorSpace,stencilBuffer:p.stencil})}else{let ae=null,pe=null,he=null;p.depth&&(he=p.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,ae=p.stencil?Os:ws,pe=p.stencil?Fs:Rr);const Le={colorFormat:n.RGBA8,depthFormat:he,scaleFactor:s};h=new XRWebGLBinding(r,n),f=h.createProjectionLayer(Le),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),g=new Pr(f.textureWidth,f.textureHeight,{format:zn,type:yi,depthTexture:new g_(f.textureWidth,f.textureHeight,pe,void 0,void 0,void 0,void 0,void 0,void 0,ae),stencilBuffer:p.stencil,colorSpace:e.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}g.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),be.setContext(r),be.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function Q($){for(let ae=0;ae<$.removed.length;ae++){const pe=$.removed[ae],he=M.indexOf(pe);he>=0&&(M[he]=null,v[he].disconnect(pe))}for(let ae=0;ae<$.added.length;ae++){const pe=$.added[ae];let he=M.indexOf(pe);if(he===-1){for(let Fe=0;Fe<v.length;Fe++)if(Fe>=M.length){M.push(pe),he=Fe;break}else if(M[Fe]===null){M[Fe]=pe,he=Fe;break}if(he===-1)break}const Le=v[he];Le&&Le.connect(pe)}}const I=new H,O=new H;function R($,ae,pe){I.setFromMatrixPosition(ae.matrixWorld),O.setFromMatrixPosition(pe.matrixWorld);const he=I.distanceTo(O),Le=ae.projectionMatrix.elements,Fe=pe.projectionMatrix.elements,ke=Le[14]/(Le[10]-1),it=Le[14]/(Le[10]+1),D=(Le[9]+1)/Le[5],ut=(Le[9]-1)/Le[5],Ye=(Le[8]-1)/Le[0],K=(Fe[8]+1)/Fe[0],Z=ke*Ye,xe=ke*K,se=he/(-Ye+K),le=se*-Ye;ae.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(le),$.translateZ(se),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert();const b=ke+se,E=it+se,W=Z-le,ie=xe+(he-le),re=D*it/E*b,J=ut*it/E*b;$.projectionMatrix.makePerspective(W,ie,re,J,b,E),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}function V($,ae){ae===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(ae.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(r===null)return;x.texture!==null&&($.near=x.depthNear,$.far=x.depthFar),y.near=L.near=A.near=$.near,y.far=L.far=A.far=$.far,(N!==y.near||z!==y.far)&&(r.updateRenderState({depthNear:y.near,depthFar:y.far}),N=y.near,z=y.far,A.near=N,A.far=z,L.near=N,L.far=z,A.updateProjectionMatrix(),L.updateProjectionMatrix(),$.updateProjectionMatrix());const ae=$.parent,pe=y.cameras;V(y,ae);for(let he=0;he<pe.length;he++)V(pe[he],ae);pe.length===2?R(y,A,L):y.projectionMatrix.copy(A.projectionMatrix),Y($,y,ae)};function Y($,ae,pe){pe===null?$.matrix.copy(ae.matrixWorld):($.matrix.copy(pe.matrixWorld),$.matrix.invert(),$.matrix.multiply(ae.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(ae.projectionMatrix),$.projectionMatrixInverse.copy(ae.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=rf*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(f===null&&m===null))return l},this.setFoveation=function($){l=$,f!==null&&(f.fixedFoveation=$),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=$)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(y)};let te=null;function _e($,ae){if(d=ae.getViewerPose(c||a),_=ae,d!==null){const pe=d.views;m!==null&&(e.setRenderTargetFramebuffer(g,m.framebuffer),e.setRenderTarget(g));let he=!1;pe.length!==y.cameras.length&&(y.cameras.length=0,he=!0);for(let Fe=0;Fe<pe.length;Fe++){const ke=pe[Fe];let it=null;if(m!==null)it=m.getViewport(ke);else{const ut=h.getViewSubImage(f,ke);it=ut.viewport,Fe===0&&(e.setRenderTargetTextures(g,ut.colorTexture,f.ignoreDepthValues?void 0:ut.depthStencilTexture),e.setRenderTarget(g))}let D=T[Fe];D===void 0&&(D=new pn,D.layers.enable(Fe),D.viewport=new Tt,T[Fe]=D),D.matrix.fromArray(ke.transform.matrix),D.matrix.decompose(D.position,D.quaternion,D.scale),D.projectionMatrix.fromArray(ke.projectionMatrix),D.projectionMatrixInverse.copy(D.projectionMatrix).invert(),D.viewport.set(it.x,it.y,it.width,it.height),Fe===0&&(y.matrix.copy(D.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),he===!0&&y.cameras.push(D)}const Le=r.enabledFeatures;if(Le&&Le.includes("depth-sensing")){const Fe=h.getDepthInformation(pe[0]);Fe&&Fe.isValid&&Fe.texture&&x.init(e,Fe,r.renderState)}}for(let pe=0;pe<v.length;pe++){const he=M[pe],Le=v[pe];he!==null&&Le!==void 0&&Le.update(he,ae,c||a)}te&&te($,ae),ae.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ae}),_=null}const be=new p_;be.setAnimationLoop(_e),this.setAnimationLoop=function($){te=$},this.dispose=function(){}}}const cr=new ei,YC=new ct;function $C(t,e){function n(p,u){p.matrixAutoUpdate===!0&&p.updateMatrix(),u.value.copy(p.matrix)}function i(p,u){u.color.getRGB(p.fogColor.value,d_(t)),u.isFog?(p.fogNear.value=u.near,p.fogFar.value=u.far):u.isFogExp2&&(p.fogDensity.value=u.density)}function r(p,u,g,v,M){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(p,u):u.isMeshToonMaterial?(s(p,u),h(p,u)):u.isMeshPhongMaterial?(s(p,u),d(p,u)):u.isMeshStandardMaterial?(s(p,u),f(p,u),u.isMeshPhysicalMaterial&&m(p,u,M)):u.isMeshMatcapMaterial?(s(p,u),_(p,u)):u.isMeshDepthMaterial?s(p,u):u.isMeshDistanceMaterial?(s(p,u),x(p,u)):u.isMeshNormalMaterial?s(p,u):u.isLineBasicMaterial?(a(p,u),u.isLineDashedMaterial&&o(p,u)):u.isPointsMaterial?l(p,u,g,v):u.isSpriteMaterial?c(p,u):u.isShadowMaterial?(p.color.value.copy(u.color),p.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(p,u){p.opacity.value=u.opacity,u.color&&p.diffuse.value.copy(u.color),u.emissive&&p.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(p.map.value=u.map,n(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,n(u.alphaMap,p.alphaMapTransform)),u.bumpMap&&(p.bumpMap.value=u.bumpMap,n(u.bumpMap,p.bumpMapTransform),p.bumpScale.value=u.bumpScale,u.side===on&&(p.bumpScale.value*=-1)),u.normalMap&&(p.normalMap.value=u.normalMap,n(u.normalMap,p.normalMapTransform),p.normalScale.value.copy(u.normalScale),u.side===on&&p.normalScale.value.negate()),u.displacementMap&&(p.displacementMap.value=u.displacementMap,n(u.displacementMap,p.displacementMapTransform),p.displacementScale.value=u.displacementScale,p.displacementBias.value=u.displacementBias),u.emissiveMap&&(p.emissiveMap.value=u.emissiveMap,n(u.emissiveMap,p.emissiveMapTransform)),u.specularMap&&(p.specularMap.value=u.specularMap,n(u.specularMap,p.specularMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest);const g=e.get(u),v=g.envMap,M=g.envMapRotation;v&&(p.envMap.value=v,cr.copy(M),cr.x*=-1,cr.y*=-1,cr.z*=-1,v.isCubeTexture&&v.isRenderTargetTexture===!1&&(cr.y*=-1,cr.z*=-1),p.envMapRotation.value.setFromMatrix4(YC.makeRotationFromEuler(cr)),p.flipEnvMap.value=v.isCubeTexture&&v.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=u.reflectivity,p.ior.value=u.ior,p.refractionRatio.value=u.refractionRatio),u.lightMap&&(p.lightMap.value=u.lightMap,p.lightMapIntensity.value=u.lightMapIntensity,n(u.lightMap,p.lightMapTransform)),u.aoMap&&(p.aoMap.value=u.aoMap,p.aoMapIntensity.value=u.aoMapIntensity,n(u.aoMap,p.aoMapTransform))}function a(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,u.map&&(p.map.value=u.map,n(u.map,p.mapTransform))}function o(p,u){p.dashSize.value=u.dashSize,p.totalSize.value=u.dashSize+u.gapSize,p.scale.value=u.scale}function l(p,u,g,v){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.size.value=u.size*g,p.scale.value=v*.5,u.map&&(p.map.value=u.map,n(u.map,p.uvTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,n(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function c(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.rotation.value=u.rotation,u.map&&(p.map.value=u.map,n(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,n(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function d(p,u){p.specular.value.copy(u.specular),p.shininess.value=Math.max(u.shininess,1e-4)}function h(p,u){u.gradientMap&&(p.gradientMap.value=u.gradientMap)}function f(p,u){p.metalness.value=u.metalness,u.metalnessMap&&(p.metalnessMap.value=u.metalnessMap,n(u.metalnessMap,p.metalnessMapTransform)),p.roughness.value=u.roughness,u.roughnessMap&&(p.roughnessMap.value=u.roughnessMap,n(u.roughnessMap,p.roughnessMapTransform)),u.envMap&&(p.envMapIntensity.value=u.envMapIntensity)}function m(p,u,g){p.ior.value=u.ior,u.sheen>0&&(p.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),p.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(p.sheenColorMap.value=u.sheenColorMap,n(u.sheenColorMap,p.sheenColorMapTransform)),u.sheenRoughnessMap&&(p.sheenRoughnessMap.value=u.sheenRoughnessMap,n(u.sheenRoughnessMap,p.sheenRoughnessMapTransform))),u.clearcoat>0&&(p.clearcoat.value=u.clearcoat,p.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(p.clearcoatMap.value=u.clearcoatMap,n(u.clearcoatMap,p.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,n(u.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(p.clearcoatNormalMap.value=u.clearcoatNormalMap,n(u.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===on&&p.clearcoatNormalScale.value.negate())),u.dispersion>0&&(p.dispersion.value=u.dispersion),u.iridescence>0&&(p.iridescence.value=u.iridescence,p.iridescenceIOR.value=u.iridescenceIOR,p.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(p.iridescenceMap.value=u.iridescenceMap,n(u.iridescenceMap,p.iridescenceMapTransform)),u.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=u.iridescenceThicknessMap,n(u.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),u.transmission>0&&(p.transmission.value=u.transmission,p.transmissionSamplerMap.value=g.texture,p.transmissionSamplerSize.value.set(g.width,g.height),u.transmissionMap&&(p.transmissionMap.value=u.transmissionMap,n(u.transmissionMap,p.transmissionMapTransform)),p.thickness.value=u.thickness,u.thicknessMap&&(p.thicknessMap.value=u.thicknessMap,n(u.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=u.attenuationDistance,p.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(p.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(p.anisotropyMap.value=u.anisotropyMap,n(u.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=u.specularIntensity,p.specularColor.value.copy(u.specularColor),u.specularColorMap&&(p.specularColorMap.value=u.specularColorMap,n(u.specularColorMap,p.specularColorMapTransform)),u.specularIntensityMap&&(p.specularIntensityMap.value=u.specularIntensityMap,n(u.specularIntensityMap,p.specularIntensityMapTransform))}function _(p,u){u.matcap&&(p.matcap.value=u.matcap)}function x(p,u){const g=e.get(u).light;p.referencePosition.value.setFromMatrixPosition(g.matrixWorld),p.nearDistance.value=g.shadow.camera.near,p.farDistance.value=g.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function qC(t,e,n,i){let r={},s={},a=[];const o=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(g,v){const M=v.program;i.uniformBlockBinding(g,M)}function c(g,v){let M=r[g.id];M===void 0&&(_(g),M=d(g),r[g.id]=M,g.addEventListener("dispose",p));const P=v.program;i.updateUBOMapping(g,P);const C=e.render.frame;s[g.id]!==C&&(f(g),s[g.id]=C)}function d(g){const v=h();g.__bindingPointIndex=v;const M=t.createBuffer(),P=g.__size,C=g.usage;return t.bindBuffer(t.UNIFORM_BUFFER,M),t.bufferData(t.UNIFORM_BUFFER,P,C),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,v,M),M}function h(){for(let g=0;g<o;g++)if(a.indexOf(g)===-1)return a.push(g),g;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(g){const v=r[g.id],M=g.uniforms,P=g.__cache;t.bindBuffer(t.UNIFORM_BUFFER,v);for(let C=0,A=M.length;C<A;C++){const L=Array.isArray(M[C])?M[C]:[M[C]];for(let T=0,y=L.length;T<y;T++){const N=L[T];if(m(N,C,T,P)===!0){const z=N.__offset,G=Array.isArray(N.value)?N.value:[N.value];let q=0;for(let Q=0;Q<G.length;Q++){const I=G[Q],O=x(I);typeof I=="number"||typeof I=="boolean"?(N.__data[0]=I,t.bufferSubData(t.UNIFORM_BUFFER,z+q,N.__data)):I.isMatrix3?(N.__data[0]=I.elements[0],N.__data[1]=I.elements[1],N.__data[2]=I.elements[2],N.__data[3]=0,N.__data[4]=I.elements[3],N.__data[5]=I.elements[4],N.__data[6]=I.elements[5],N.__data[7]=0,N.__data[8]=I.elements[6],N.__data[9]=I.elements[7],N.__data[10]=I.elements[8],N.__data[11]=0):(I.toArray(N.__data,q),q+=O.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,z,N.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function m(g,v,M,P){const C=g.value,A=v+"_"+M;if(P[A]===void 0)return typeof C=="number"||typeof C=="boolean"?P[A]=C:P[A]=C.clone(),!0;{const L=P[A];if(typeof C=="number"||typeof C=="boolean"){if(L!==C)return P[A]=C,!0}else if(L.equals(C)===!1)return L.copy(C),!0}return!1}function _(g){const v=g.uniforms;let M=0;const P=16;for(let A=0,L=v.length;A<L;A++){const T=Array.isArray(v[A])?v[A]:[v[A]];for(let y=0,N=T.length;y<N;y++){const z=T[y],G=Array.isArray(z.value)?z.value:[z.value];for(let q=0,Q=G.length;q<Q;q++){const I=G[q],O=x(I),R=M%P,V=R%O.boundary,Y=R+V;M+=V,Y!==0&&P-Y<O.storage&&(M+=P-Y),z.__data=new Float32Array(O.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=M,M+=O.storage}}}const C=M%P;return C>0&&(M+=P-C),g.__size=M,g.__cache={},this}function x(g){const v={boundary:0,storage:0};return typeof g=="number"||typeof g=="boolean"?(v.boundary=4,v.storage=4):g.isVector2?(v.boundary=8,v.storage=8):g.isVector3||g.isColor?(v.boundary=16,v.storage=12):g.isVector4?(v.boundary=16,v.storage=16):g.isMatrix3?(v.boundary=48,v.storage=48):g.isMatrix4?(v.boundary=64,v.storage=64):g.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",g),v}function p(g){const v=g.target;v.removeEventListener("dispose",p);const M=a.indexOf(v.__bindingPointIndex);a.splice(M,1),t.deleteBuffer(r[v.id]),delete r[v.id],delete s[v.id]}function u(){for(const g in r)t.deleteBuffer(r[g]);a=[],r={},s={}}return{bind:l,update:c,dispose:u}}class S_{constructor(e={}){const{canvas:n=BE(),context:i=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:h=!1}=e;this.isWebGLRenderer=!0;let f;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=i.getContextAttributes().alpha}else f=a;const m=new Uint32Array(4),_=new Int32Array(4);let x=null,p=null;const u=[],g=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Mn,this.toneMapping=Yi,this.toneMappingExposure=1;const v=this;let M=!1,P=0,C=0,A=null,L=-1,T=null;const y=new Tt,N=new Tt;let z=null;const G=new je(0);let q=0,Q=n.width,I=n.height,O=1,R=null,V=null;const Y=new Tt(0,0,Q,I),te=new Tt(0,0,Q,I);let _e=!1;const be=new ph;let $=!1,ae=!1;const pe=new ct,he=new H,Le=new Tt,Fe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ke=!1;function it(){return A===null?O:1}let D=i;function ut(w,k){return n.getContext(w,k)}try{const w={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${ih}`),n.addEventListener("webglcontextlost",ee,!1),n.addEventListener("webglcontextrestored",ne,!1),n.addEventListener("webglcontextcreationerror",fe,!1),D===null){const k="webgl2";if(D=ut(k,w),D===null)throw ut(k)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(w){throw console.error("THREE.WebGLRenderer: "+w.message),w}let Ye,K,Z,xe,se,le,b,E,W,ie,re,J,Ce,ge,Me,ze,ce,Se,Xe,Ue,Ee,Oe,He,dt;function F(){Ye=new nA(D),Ye.init(),Oe=new BC(D,Ye),K=new KT(D,Ye,e,Oe),Z=new OC(D),xe=new sA(D),se=new EC,le=new zC(D,Ye,Z,se,K,Oe,xe),b=new QT(v),E=new tA(v),W=new f1(D),He=new $T(D,W),ie=new iA(D,W,xe,He),re=new oA(D,ie,W,xe),Xe=new aA(D,K,le),ze=new ZT(se),J=new MC(v,b,E,Ye,K,He,ze),Ce=new $C(v,se),ge=new TC,Me=new LC(Ye),Se=new YT(v,b,E,Z,re,f,l),ce=new FC(v,re,K),dt=new qC(D,xe,K,Z),Ue=new qT(D,Ye,xe),Ee=new rA(D,Ye,xe),xe.programs=J.programs,v.capabilities=K,v.extensions=Ye,v.properties=se,v.renderLists=ge,v.shadowMap=ce,v.state=Z,v.info=xe}F();const ue=new XC(v,D);this.xr=ue,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){const w=Ye.get("WEBGL_lose_context");w&&w.loseContext()},this.forceContextRestore=function(){const w=Ye.get("WEBGL_lose_context");w&&w.restoreContext()},this.getPixelRatio=function(){return O},this.setPixelRatio=function(w){w!==void 0&&(O=w,this.setSize(Q,I,!1))},this.getSize=function(w){return w.set(Q,I)},this.setSize=function(w,k,j=!0){if(ue.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Q=w,I=k,n.width=Math.floor(w*O),n.height=Math.floor(k*O),j===!0&&(n.style.width=w+"px",n.style.height=k+"px"),this.setViewport(0,0,w,k)},this.getDrawingBufferSize=function(w){return w.set(Q*O,I*O).floor()},this.setDrawingBufferSize=function(w,k,j){Q=w,I=k,O=j,n.width=Math.floor(w*j),n.height=Math.floor(k*j),this.setViewport(0,0,w,k)},this.getCurrentViewport=function(w){return w.copy(y)},this.getViewport=function(w){return w.copy(Y)},this.setViewport=function(w,k,j,X){w.isVector4?Y.set(w.x,w.y,w.z,w.w):Y.set(w,k,j,X),Z.viewport(y.copy(Y).multiplyScalar(O).round())},this.getScissor=function(w){return w.copy(te)},this.setScissor=function(w,k,j,X){w.isVector4?te.set(w.x,w.y,w.z,w.w):te.set(w,k,j,X),Z.scissor(N.copy(te).multiplyScalar(O).round())},this.getScissorTest=function(){return _e},this.setScissorTest=function(w){Z.setScissorTest(_e=w)},this.setOpaqueSort=function(w){R=w},this.setTransparentSort=function(w){V=w},this.getClearColor=function(w){return w.copy(Se.getClearColor())},this.setClearColor=function(){Se.setClearColor.apply(Se,arguments)},this.getClearAlpha=function(){return Se.getClearAlpha()},this.setClearAlpha=function(){Se.setClearAlpha.apply(Se,arguments)},this.clear=function(w=!0,k=!0,j=!0){let X=0;if(w){let B=!1;if(A!==null){const de=A.texture.format;B=de===ch||de===lh||de===oh}if(B){const de=A.texture.type,ve=de===yi||de===Rr||de===Ga||de===Fs||de===sh||de===ah,we=Se.getClearColor(),Te=Se.getClearAlpha(),De=we.r,Ie=we.g,Re=we.b;ve?(m[0]=De,m[1]=Ie,m[2]=Re,m[3]=Te,D.clearBufferuiv(D.COLOR,0,m)):(_[0]=De,_[1]=Ie,_[2]=Re,_[3]=Te,D.clearBufferiv(D.COLOR,0,_))}else X|=D.COLOR_BUFFER_BIT}k&&(X|=D.DEPTH_BUFFER_BIT),j&&(X|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),D.clear(X)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",ee,!1),n.removeEventListener("webglcontextrestored",ne,!1),n.removeEventListener("webglcontextcreationerror",fe,!1),ge.dispose(),Me.dispose(),se.dispose(),b.dispose(),E.dispose(),re.dispose(),He.dispose(),dt.dispose(),J.dispose(),ue.dispose(),ue.removeEventListener("sessionstart",Wn),ue.removeEventListener("sessionend",_h),ir.stop()};function ee(w){w.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),M=!0}function ne(){console.log("THREE.WebGLRenderer: Context Restored."),M=!1;const w=xe.autoReset,k=ce.enabled,j=ce.autoUpdate,X=ce.needsUpdate,B=ce.type;F(),xe.autoReset=w,ce.enabled=k,ce.autoUpdate=j,ce.needsUpdate=X,ce.type=B}function fe(w){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",w.statusMessage)}function Ne(w){const k=w.target;k.removeEventListener("dispose",Ne),$e(k)}function $e(w){xt(w),se.remove(w)}function xt(w){const k=se.get(w).programs;k!==void 0&&(k.forEach(function(j){J.releaseProgram(j)}),w.isShaderMaterial&&J.releaseShaderCache(w))}this.renderBufferDirect=function(w,k,j,X,B,de){k===null&&(k=Fe);const ve=B.isMesh&&B.matrixWorld.determinant()<0,we=L_(w,k,j,X,B);Z.setMaterial(X,ve);let Te=j.index,De=1;if(X.wireframe===!0){if(Te=ie.getWireframeAttribute(j),Te===void 0)return;De=2}const Ie=j.drawRange,Re=j.attributes.position;let Ze=Ie.start*De,mt=(Ie.start+Ie.count)*De;de!==null&&(Ze=Math.max(Ze,de.start*De),mt=Math.min(mt,(de.start+de.count)*De)),Te!==null?(Ze=Math.max(Ze,0),mt=Math.min(mt,Te.count)):Re!=null&&(Ze=Math.max(Ze,0),mt=Math.min(mt,Re.count));const gt=mt-Ze;if(gt<0||gt===1/0)return;He.setup(B,X,we,j,Te);let cn,Qe=Ue;if(Te!==null&&(cn=W.get(Te),Qe=Ee,Qe.setIndex(cn)),B.isMesh)X.wireframe===!0?(Z.setLineWidth(X.wireframeLinewidth*it()),Qe.setMode(D.LINES)):Qe.setMode(D.TRIANGLES);else if(B.isLine){let Ae=X.linewidth;Ae===void 0&&(Ae=1),Z.setLineWidth(Ae*it()),B.isLineSegments?Qe.setMode(D.LINES):B.isLineLoop?Qe.setMode(D.LINE_LOOP):Qe.setMode(D.LINE_STRIP)}else B.isPoints?Qe.setMode(D.POINTS):B.isSprite&&Qe.setMode(D.TRIANGLES);if(B.isBatchedMesh)if(B._multiDrawInstances!==null)Qe.renderMultiDrawInstances(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount,B._multiDrawInstances);else if(Ye.get("WEBGL_multi_draw"))Qe.renderMultiDraw(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount);else{const Ae=B._multiDrawStarts,Dt=B._multiDrawCounts,Je=B._multiDrawCount,Pn=Te?W.get(Te).bytesPerElement:1,kr=se.get(X).currentProgram.getUniforms();for(let un=0;un<Je;un++)kr.setValue(D,"_gl_DrawID",un),Qe.render(Ae[un]/Pn,Dt[un])}else if(B.isInstancedMesh)Qe.renderInstances(Ze,gt,B.count);else if(j.isInstancedBufferGeometry){const Ae=j._maxInstanceCount!==void 0?j._maxInstanceCount:1/0,Dt=Math.min(j.instanceCount,Ae);Qe.renderInstances(Ze,gt,Dt)}else Qe.render(Ze,gt)};function Nt(w,k,j){w.transparent===!0&&w.side===qn&&w.forceSinglePass===!1?(w.side=on,w.needsUpdate=!0,no(w,k,j),w.side=Ki,w.needsUpdate=!0,no(w,k,j),w.side=qn):no(w,k,j)}this.compile=function(w,k,j=null){j===null&&(j=w),p=Me.get(j),p.init(k),g.push(p),j.traverseVisible(function(B){B.isLight&&B.layers.test(k.layers)&&(p.pushLight(B),B.castShadow&&p.pushShadow(B))}),w!==j&&w.traverseVisible(function(B){B.isLight&&B.layers.test(k.layers)&&(p.pushLight(B),B.castShadow&&p.pushShadow(B))}),p.setupLights();const X=new Set;return w.traverse(function(B){const de=B.material;if(de)if(Array.isArray(de))for(let ve=0;ve<de.length;ve++){const we=de[ve];Nt(we,j,B),X.add(we)}else Nt(de,j,B),X.add(de)}),g.pop(),p=null,X},this.compileAsync=function(w,k,j=null){const X=this.compile(w,k,j);return new Promise(B=>{function de(){if(X.forEach(function(ve){se.get(ve).currentProgram.isReady()&&X.delete(ve)}),X.size===0){B(w);return}setTimeout(de,10)}Ye.get("KHR_parallel_shader_compile")!==null?de():setTimeout(de,10)})};let Ke=null;function ti(w){Ke&&Ke(w)}function Wn(){ir.stop()}function _h(){ir.start()}const ir=new p_;ir.setAnimationLoop(ti),typeof self<"u"&&ir.setContext(self),this.setAnimationLoop=function(w){Ke=w,ue.setAnimationLoop(w),w===null?ir.stop():ir.start()},ue.addEventListener("sessionstart",Wn),ue.addEventListener("sessionend",_h),this.render=function(w,k){if(k!==void 0&&k.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(M===!0)return;if(w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),k.parent===null&&k.matrixWorldAutoUpdate===!0&&k.updateMatrixWorld(),ue.enabled===!0&&ue.isPresenting===!0&&(ue.cameraAutoUpdate===!0&&ue.updateCamera(k),k=ue.getCamera()),w.isScene===!0&&w.onBeforeRender(v,w,k,A),p=Me.get(w,g.length),p.init(k),g.push(p),pe.multiplyMatrices(k.projectionMatrix,k.matrixWorldInverse),be.setFromProjectionMatrix(pe),ae=this.localClippingEnabled,$=ze.init(this.clippingPlanes,ae),x=ge.get(w,u.length),x.init(),u.push(x),ue.enabled===!0&&ue.isPresenting===!0){const de=v.xr.getDepthSensingMesh();de!==null&&mc(de,k,-1/0,v.sortObjects)}mc(w,k,0,v.sortObjects),x.finish(),v.sortObjects===!0&&x.sort(R,V),ke=ue.enabled===!1||ue.isPresenting===!1||ue.hasDepthSensing()===!1,ke&&Se.addToRenderList(x,w),this.info.render.frame++,$===!0&&ze.beginShadows();const j=p.state.shadowsArray;ce.render(j,w,k),$===!0&&ze.endShadows(),this.info.autoReset===!0&&this.info.reset();const X=x.opaque,B=x.transmissive;if(p.setupLights(),k.isArrayCamera){const de=k.cameras;if(B.length>0)for(let ve=0,we=de.length;ve<we;ve++){const Te=de[ve];yh(X,B,w,Te)}ke&&Se.render(w);for(let ve=0,we=de.length;ve<we;ve++){const Te=de[ve];xh(x,w,Te,Te.viewport)}}else B.length>0&&yh(X,B,w,k),ke&&Se.render(w),xh(x,w,k);A!==null&&(le.updateMultisampleRenderTarget(A),le.updateRenderTargetMipmap(A)),w.isScene===!0&&w.onAfterRender(v,w,k),He.resetDefaultState(),L=-1,T=null,g.pop(),g.length>0?(p=g[g.length-1],$===!0&&ze.setGlobalState(v.clippingPlanes,p.state.camera)):p=null,u.pop(),u.length>0?x=u[u.length-1]:x=null};function mc(w,k,j,X){if(w.visible===!1)return;if(w.layers.test(k.layers)){if(w.isGroup)j=w.renderOrder;else if(w.isLOD)w.autoUpdate===!0&&w.update(k);else if(w.isLight)p.pushLight(w),w.castShadow&&p.pushShadow(w);else if(w.isSprite){if(!w.frustumCulled||be.intersectsSprite(w)){X&&Le.setFromMatrixPosition(w.matrixWorld).applyMatrix4(pe);const ve=re.update(w),we=w.material;we.visible&&x.push(w,ve,we,j,Le.z,null)}}else if((w.isMesh||w.isLine||w.isPoints)&&(!w.frustumCulled||be.intersectsObject(w))){const ve=re.update(w),we=w.material;if(X&&(w.boundingSphere!==void 0?(w.boundingSphere===null&&w.computeBoundingSphere(),Le.copy(w.boundingSphere.center)):(ve.boundingSphere===null&&ve.computeBoundingSphere(),Le.copy(ve.boundingSphere.center)),Le.applyMatrix4(w.matrixWorld).applyMatrix4(pe)),Array.isArray(we)){const Te=ve.groups;for(let De=0,Ie=Te.length;De<Ie;De++){const Re=Te[De],Ze=we[Re.materialIndex];Ze&&Ze.visible&&x.push(w,ve,Ze,j,Le.z,Re)}}else we.visible&&x.push(w,ve,we,j,Le.z,null)}}const de=w.children;for(let ve=0,we=de.length;ve<we;ve++)mc(de[ve],k,j,X)}function xh(w,k,j,X){const B=w.opaque,de=w.transmissive,ve=w.transparent;p.setupLightsView(j),$===!0&&ze.setGlobalState(v.clippingPlanes,j),X&&Z.viewport(y.copy(X)),B.length>0&&to(B,k,j),de.length>0&&to(de,k,j),ve.length>0&&to(ve,k,j),Z.buffers.depth.setTest(!0),Z.buffers.depth.setMask(!0),Z.buffers.color.setMask(!0),Z.setPolygonOffset(!1)}function yh(w,k,j,X){if((j.isScene===!0?j.overrideMaterial:null)!==null)return;p.state.transmissionRenderTarget[X.id]===void 0&&(p.state.transmissionRenderTarget[X.id]=new Pr(1,1,{generateMipmaps:!0,type:Ye.has("EXT_color_buffer_half_float")||Ye.has("EXT_color_buffer_float")?Za:yi,minFilter:yr,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:et.workingColorSpace}));const de=p.state.transmissionRenderTarget[X.id],ve=X.viewport||y;de.setSize(ve.z,ve.w);const we=v.getRenderTarget();v.setRenderTarget(de),v.getClearColor(G),q=v.getClearAlpha(),q<1&&v.setClearColor(16777215,.5),v.clear(),ke&&Se.render(j);const Te=v.toneMapping;v.toneMapping=Yi;const De=X.viewport;if(X.viewport!==void 0&&(X.viewport=void 0),p.setupLightsView(X),$===!0&&ze.setGlobalState(v.clippingPlanes,X),to(w,j,X),le.updateMultisampleRenderTarget(de),le.updateRenderTargetMipmap(de),Ye.has("WEBGL_multisampled_render_to_texture")===!1){let Ie=!1;for(let Re=0,Ze=k.length;Re<Ze;Re++){const mt=k[Re],gt=mt.object,cn=mt.geometry,Qe=mt.material,Ae=mt.group;if(Qe.side===qn&&gt.layers.test(X.layers)){const Dt=Qe.side;Qe.side=on,Qe.needsUpdate=!0,Sh(gt,j,X,cn,Qe,Ae),Qe.side=Dt,Qe.needsUpdate=!0,Ie=!0}}Ie===!0&&(le.updateMultisampleRenderTarget(de),le.updateRenderTargetMipmap(de))}v.setRenderTarget(we),v.setClearColor(G,q),De!==void 0&&(X.viewport=De),v.toneMapping=Te}function to(w,k,j){const X=k.isScene===!0?k.overrideMaterial:null;for(let B=0,de=w.length;B<de;B++){const ve=w[B],we=ve.object,Te=ve.geometry,De=X===null?ve.material:X,Ie=ve.group;we.layers.test(j.layers)&&Sh(we,k,j,Te,De,Ie)}}function Sh(w,k,j,X,B,de){w.onBeforeRender(v,k,j,X,B,de),w.modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,w.matrixWorld),w.normalMatrix.getNormalMatrix(w.modelViewMatrix),B.transparent===!0&&B.side===qn&&B.forceSinglePass===!1?(B.side=on,B.needsUpdate=!0,v.renderBufferDirect(j,k,X,B,w,de),B.side=Ki,B.needsUpdate=!0,v.renderBufferDirect(j,k,X,B,w,de),B.side=qn):v.renderBufferDirect(j,k,X,B,w,de),w.onAfterRender(v,k,j,X,B,de)}function no(w,k,j){k.isScene!==!0&&(k=Fe);const X=se.get(w),B=p.state.lights,de=p.state.shadowsArray,ve=B.state.version,we=J.getParameters(w,B.state,de,k,j),Te=J.getProgramCacheKey(we);let De=X.programs;X.environment=w.isMeshStandardMaterial?k.environment:null,X.fog=k.fog,X.envMap=(w.isMeshStandardMaterial?E:b).get(w.envMap||X.environment),X.envMapRotation=X.environment!==null&&w.envMap===null?k.environmentRotation:w.envMapRotation,De===void 0&&(w.addEventListener("dispose",Ne),De=new Map,X.programs=De);let Ie=De.get(Te);if(Ie!==void 0){if(X.currentProgram===Ie&&X.lightsStateVersion===ve)return Eh(w,we),Ie}else we.uniforms=J.getUniforms(w),w.onBeforeCompile(we,v),Ie=J.acquireProgram(we,Te),De.set(Te,Ie),X.uniforms=we.uniforms;const Re=X.uniforms;return(!w.isShaderMaterial&&!w.isRawShaderMaterial||w.clipping===!0)&&(Re.clippingPlanes=ze.uniform),Eh(w,we),X.needsLights=D_(w),X.lightsStateVersion=ve,X.needsLights&&(Re.ambientLightColor.value=B.state.ambient,Re.lightProbe.value=B.state.probe,Re.directionalLights.value=B.state.directional,Re.directionalLightShadows.value=B.state.directionalShadow,Re.spotLights.value=B.state.spot,Re.spotLightShadows.value=B.state.spotShadow,Re.rectAreaLights.value=B.state.rectArea,Re.ltc_1.value=B.state.rectAreaLTC1,Re.ltc_2.value=B.state.rectAreaLTC2,Re.pointLights.value=B.state.point,Re.pointLightShadows.value=B.state.pointShadow,Re.hemisphereLights.value=B.state.hemi,Re.directionalShadowMap.value=B.state.directionalShadowMap,Re.directionalShadowMatrix.value=B.state.directionalShadowMatrix,Re.spotShadowMap.value=B.state.spotShadowMap,Re.spotLightMatrix.value=B.state.spotLightMatrix,Re.spotLightMap.value=B.state.spotLightMap,Re.pointShadowMap.value=B.state.pointShadowMap,Re.pointShadowMatrix.value=B.state.pointShadowMatrix),X.currentProgram=Ie,X.uniformsList=null,Ie}function Mh(w){if(w.uniformsList===null){const k=w.currentProgram.getUniforms();w.uniformsList=ul.seqWithValue(k.seq,w.uniforms)}return w.uniformsList}function Eh(w,k){const j=se.get(w);j.outputColorSpace=k.outputColorSpace,j.batching=k.batching,j.batchingColor=k.batchingColor,j.instancing=k.instancing,j.instancingColor=k.instancingColor,j.instancingMorph=k.instancingMorph,j.skinning=k.skinning,j.morphTargets=k.morphTargets,j.morphNormals=k.morphNormals,j.morphColors=k.morphColors,j.morphTargetsCount=k.morphTargetsCount,j.numClippingPlanes=k.numClippingPlanes,j.numIntersection=k.numClipIntersection,j.vertexAlphas=k.vertexAlphas,j.vertexTangents=k.vertexTangents,j.toneMapping=k.toneMapping}function L_(w,k,j,X,B){k.isScene!==!0&&(k=Fe),le.resetTextureUnits();const de=k.fog,ve=X.isMeshStandardMaterial?k.environment:null,we=A===null?v.outputColorSpace:A.isXRRenderTarget===!0?A.texture.colorSpace:tr,Te=(X.isMeshStandardMaterial?E:b).get(X.envMap||ve),De=X.vertexColors===!0&&!!j.attributes.color&&j.attributes.color.itemSize===4,Ie=!!j.attributes.tangent&&(!!X.normalMap||X.anisotropy>0),Re=!!j.morphAttributes.position,Ze=!!j.morphAttributes.normal,mt=!!j.morphAttributes.color;let gt=Yi;X.toneMapped&&(A===null||A.isXRRenderTarget===!0)&&(gt=v.toneMapping);const cn=j.morphAttributes.position||j.morphAttributes.normal||j.morphAttributes.color,Qe=cn!==void 0?cn.length:0,Ae=se.get(X),Dt=p.state.lights;if($===!0&&(ae===!0||w!==T)){const yn=w===T&&X.id===L;ze.setState(X,w,yn)}let Je=!1;X.version===Ae.__version?(Ae.needsLights&&Ae.lightsStateVersion!==Dt.state.version||Ae.outputColorSpace!==we||B.isBatchedMesh&&Ae.batching===!1||!B.isBatchedMesh&&Ae.batching===!0||B.isBatchedMesh&&Ae.batchingColor===!0&&B.colorTexture===null||B.isBatchedMesh&&Ae.batchingColor===!1&&B.colorTexture!==null||B.isInstancedMesh&&Ae.instancing===!1||!B.isInstancedMesh&&Ae.instancing===!0||B.isSkinnedMesh&&Ae.skinning===!1||!B.isSkinnedMesh&&Ae.skinning===!0||B.isInstancedMesh&&Ae.instancingColor===!0&&B.instanceColor===null||B.isInstancedMesh&&Ae.instancingColor===!1&&B.instanceColor!==null||B.isInstancedMesh&&Ae.instancingMorph===!0&&B.morphTexture===null||B.isInstancedMesh&&Ae.instancingMorph===!1&&B.morphTexture!==null||Ae.envMap!==Te||X.fog===!0&&Ae.fog!==de||Ae.numClippingPlanes!==void 0&&(Ae.numClippingPlanes!==ze.numPlanes||Ae.numIntersection!==ze.numIntersection)||Ae.vertexAlphas!==De||Ae.vertexTangents!==Ie||Ae.morphTargets!==Re||Ae.morphNormals!==Ze||Ae.morphColors!==mt||Ae.toneMapping!==gt||Ae.morphTargetsCount!==Qe)&&(Je=!0):(Je=!0,Ae.__version=X.version);let Pn=Ae.currentProgram;Je===!0&&(Pn=no(X,k,B));let kr=!1,un=!1,gc=!1;const yt=Pn.getUniforms(),Mi=Ae.uniforms;if(Z.useProgram(Pn.program)&&(kr=!0,un=!0,gc=!0),X.id!==L&&(L=X.id,un=!0),kr||T!==w){yt.setValue(D,"projectionMatrix",w.projectionMatrix),yt.setValue(D,"viewMatrix",w.matrixWorldInverse);const yn=yt.map.cameraPosition;yn!==void 0&&yn.setValue(D,he.setFromMatrixPosition(w.matrixWorld)),K.logarithmicDepthBuffer&&yt.setValue(D,"logDepthBufFC",2/(Math.log(w.far+1)/Math.LN2)),(X.isMeshPhongMaterial||X.isMeshToonMaterial||X.isMeshLambertMaterial||X.isMeshBasicMaterial||X.isMeshStandardMaterial||X.isShaderMaterial)&&yt.setValue(D,"isOrthographic",w.isOrthographicCamera===!0),T!==w&&(T=w,un=!0,gc=!0)}if(B.isSkinnedMesh){yt.setOptional(D,B,"bindMatrix"),yt.setOptional(D,B,"bindMatrixInverse");const yn=B.skeleton;yn&&(yn.boneTexture===null&&yn.computeBoneTexture(),yt.setValue(D,"boneTexture",yn.boneTexture,le))}B.isBatchedMesh&&(yt.setOptional(D,B,"batchingTexture"),yt.setValue(D,"batchingTexture",B._matricesTexture,le),yt.setOptional(D,B,"batchingIdTexture"),yt.setValue(D,"batchingIdTexture",B._indirectTexture,le),yt.setOptional(D,B,"batchingColorTexture"),B._colorsTexture!==null&&yt.setValue(D,"batchingColorTexture",B._colorsTexture,le));const vc=j.morphAttributes;if((vc.position!==void 0||vc.normal!==void 0||vc.color!==void 0)&&Xe.update(B,j,Pn),(un||Ae.receiveShadow!==B.receiveShadow)&&(Ae.receiveShadow=B.receiveShadow,yt.setValue(D,"receiveShadow",B.receiveShadow)),X.isMeshGouraudMaterial&&X.envMap!==null&&(Mi.envMap.value=Te,Mi.flipEnvMap.value=Te.isCubeTexture&&Te.isRenderTargetTexture===!1?-1:1),X.isMeshStandardMaterial&&X.envMap===null&&k.environment!==null&&(Mi.envMapIntensity.value=k.environmentIntensity),un&&(yt.setValue(D,"toneMappingExposure",v.toneMappingExposure),Ae.needsLights&&N_(Mi,gc),de&&X.fog===!0&&Ce.refreshFogUniforms(Mi,de),Ce.refreshMaterialUniforms(Mi,X,O,I,p.state.transmissionRenderTarget[w.id]),ul.upload(D,Mh(Ae),Mi,le)),X.isShaderMaterial&&X.uniformsNeedUpdate===!0&&(ul.upload(D,Mh(Ae),Mi,le),X.uniformsNeedUpdate=!1),X.isSpriteMaterial&&yt.setValue(D,"center",B.center),yt.setValue(D,"modelViewMatrix",B.modelViewMatrix),yt.setValue(D,"normalMatrix",B.normalMatrix),yt.setValue(D,"modelMatrix",B.matrixWorld),X.isShaderMaterial||X.isRawShaderMaterial){const yn=X.uniformsGroups;for(let _c=0,I_=yn.length;_c<I_;_c++){const wh=yn[_c];dt.update(wh,Pn),dt.bind(wh,Pn)}}return Pn}function N_(w,k){w.ambientLightColor.needsUpdate=k,w.lightProbe.needsUpdate=k,w.directionalLights.needsUpdate=k,w.directionalLightShadows.needsUpdate=k,w.pointLights.needsUpdate=k,w.pointLightShadows.needsUpdate=k,w.spotLights.needsUpdate=k,w.spotLightShadows.needsUpdate=k,w.rectAreaLights.needsUpdate=k,w.hemisphereLights.needsUpdate=k}function D_(w){return w.isMeshLambertMaterial||w.isMeshToonMaterial||w.isMeshPhongMaterial||w.isMeshStandardMaterial||w.isShadowMaterial||w.isShaderMaterial&&w.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return A},this.setRenderTargetTextures=function(w,k,j){se.get(w.texture).__webglTexture=k,se.get(w.depthTexture).__webglTexture=j;const X=se.get(w);X.__hasExternalTextures=!0,X.__autoAllocateDepthBuffer=j===void 0,X.__autoAllocateDepthBuffer||Ye.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),X.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(w,k){const j=se.get(w);j.__webglFramebuffer=k,j.__useDefaultFramebuffer=k===void 0},this.setRenderTarget=function(w,k=0,j=0){A=w,P=k,C=j;let X=!0,B=null,de=!1,ve=!1;if(w){const Te=se.get(w);Te.__useDefaultFramebuffer!==void 0?(Z.bindFramebuffer(D.FRAMEBUFFER,null),X=!1):Te.__webglFramebuffer===void 0?le.setupRenderTarget(w):Te.__hasExternalTextures&&le.rebindTextures(w,se.get(w.texture).__webglTexture,se.get(w.depthTexture).__webglTexture);const De=w.texture;(De.isData3DTexture||De.isDataArrayTexture||De.isCompressedArrayTexture)&&(ve=!0);const Ie=se.get(w).__webglFramebuffer;w.isWebGLCubeRenderTarget?(Array.isArray(Ie[k])?B=Ie[k][j]:B=Ie[k],de=!0):w.samples>0&&le.useMultisampledRTT(w)===!1?B=se.get(w).__webglMultisampledFramebuffer:Array.isArray(Ie)?B=Ie[j]:B=Ie,y.copy(w.viewport),N.copy(w.scissor),z=w.scissorTest}else y.copy(Y).multiplyScalar(O).floor(),N.copy(te).multiplyScalar(O).floor(),z=_e;if(Z.bindFramebuffer(D.FRAMEBUFFER,B)&&X&&Z.drawBuffers(w,B),Z.viewport(y),Z.scissor(N),Z.setScissorTest(z),de){const Te=se.get(w.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+k,Te.__webglTexture,j)}else if(ve){const Te=se.get(w.texture),De=k||0;D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,Te.__webglTexture,j||0,De)}L=-1},this.readRenderTargetPixels=function(w,k,j,X,B,de,ve){if(!(w&&w.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let we=se.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&ve!==void 0&&(we=we[ve]),we){Z.bindFramebuffer(D.FRAMEBUFFER,we);try{const Te=w.texture,De=Te.format,Ie=Te.type;if(!K.textureFormatReadable(De)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!K.textureTypeReadable(Ie)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}k>=0&&k<=w.width-X&&j>=0&&j<=w.height-B&&D.readPixels(k,j,X,B,Oe.convert(De),Oe.convert(Ie),de)}finally{const Te=A!==null?se.get(A).__webglFramebuffer:null;Z.bindFramebuffer(D.FRAMEBUFFER,Te)}}},this.readRenderTargetPixelsAsync=async function(w,k,j,X,B,de,ve){if(!(w&&w.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let we=se.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&ve!==void 0&&(we=we[ve]),we){Z.bindFramebuffer(D.FRAMEBUFFER,we);try{const Te=w.texture,De=Te.format,Ie=Te.type;if(!K.textureFormatReadable(De))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!K.textureTypeReadable(Ie))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(k>=0&&k<=w.width-X&&j>=0&&j<=w.height-B){const Re=D.createBuffer();D.bindBuffer(D.PIXEL_PACK_BUFFER,Re),D.bufferData(D.PIXEL_PACK_BUFFER,de.byteLength,D.STREAM_READ),D.readPixels(k,j,X,B,Oe.convert(De),Oe.convert(Ie),0),D.flush();const Ze=D.fenceSync(D.SYNC_GPU_COMMANDS_COMPLETE,0);await VE(D,Ze,4);try{D.bindBuffer(D.PIXEL_PACK_BUFFER,Re),D.getBufferSubData(D.PIXEL_PACK_BUFFER,0,de)}finally{D.deleteBuffer(Re),D.deleteSync(Ze)}return de}}finally{const Te=A!==null?se.get(A).__webglFramebuffer:null;Z.bindFramebuffer(D.FRAMEBUFFER,Te)}}},this.copyFramebufferToTexture=function(w,k=null,j=0){w.isTexture!==!0&&(Ma("WebGLRenderer: copyFramebufferToTexture function signature has changed."),k=arguments[0]||null,w=arguments[1]);const X=Math.pow(2,-j),B=Math.floor(w.image.width*X),de=Math.floor(w.image.height*X),ve=k!==null?k.x:0,we=k!==null?k.y:0;le.setTexture2D(w,0),D.copyTexSubImage2D(D.TEXTURE_2D,j,0,0,ve,we,B,de),Z.unbindTexture()},this.copyTextureToTexture=function(w,k,j=null,X=null,B=0){w.isTexture!==!0&&(Ma("WebGLRenderer: copyTextureToTexture function signature has changed."),X=arguments[0]||null,w=arguments[1],k=arguments[2],B=arguments[3]||0,j=null);let de,ve,we,Te,De,Ie;j!==null?(de=j.max.x-j.min.x,ve=j.max.y-j.min.y,we=j.min.x,Te=j.min.y):(de=w.image.width,ve=w.image.height,we=0,Te=0),X!==null?(De=X.x,Ie=X.y):(De=0,Ie=0);const Re=Oe.convert(k.format),Ze=Oe.convert(k.type);le.setTexture2D(k,0),D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,k.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,k.unpackAlignment);const mt=D.getParameter(D.UNPACK_ROW_LENGTH),gt=D.getParameter(D.UNPACK_IMAGE_HEIGHT),cn=D.getParameter(D.UNPACK_SKIP_PIXELS),Qe=D.getParameter(D.UNPACK_SKIP_ROWS),Ae=D.getParameter(D.UNPACK_SKIP_IMAGES),Dt=w.isCompressedTexture?w.mipmaps[B]:w.image;D.pixelStorei(D.UNPACK_ROW_LENGTH,Dt.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,Dt.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,we),D.pixelStorei(D.UNPACK_SKIP_ROWS,Te),w.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,B,De,Ie,de,ve,Re,Ze,Dt.data):w.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,B,De,Ie,Dt.width,Dt.height,Re,Dt.data):D.texSubImage2D(D.TEXTURE_2D,B,De,Ie,de,ve,Re,Ze,Dt),D.pixelStorei(D.UNPACK_ROW_LENGTH,mt),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,gt),D.pixelStorei(D.UNPACK_SKIP_PIXELS,cn),D.pixelStorei(D.UNPACK_SKIP_ROWS,Qe),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Ae),B===0&&k.generateMipmaps&&D.generateMipmap(D.TEXTURE_2D),Z.unbindTexture()},this.copyTextureToTexture3D=function(w,k,j=null,X=null,B=0){w.isTexture!==!0&&(Ma("WebGLRenderer: copyTextureToTexture3D function signature has changed."),j=arguments[0]||null,X=arguments[1]||null,w=arguments[2],k=arguments[3],B=arguments[4]||0);let de,ve,we,Te,De,Ie,Re,Ze,mt;const gt=w.isCompressedTexture?w.mipmaps[B]:w.image;j!==null?(de=j.max.x-j.min.x,ve=j.max.y-j.min.y,we=j.max.z-j.min.z,Te=j.min.x,De=j.min.y,Ie=j.min.z):(de=gt.width,ve=gt.height,we=gt.depth,Te=0,De=0,Ie=0),X!==null?(Re=X.x,Ze=X.y,mt=X.z):(Re=0,Ze=0,mt=0);const cn=Oe.convert(k.format),Qe=Oe.convert(k.type);let Ae;if(k.isData3DTexture)le.setTexture3D(k,0),Ae=D.TEXTURE_3D;else if(k.isDataArrayTexture||k.isCompressedArrayTexture)le.setTexture2DArray(k,0),Ae=D.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,k.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,k.unpackAlignment);const Dt=D.getParameter(D.UNPACK_ROW_LENGTH),Je=D.getParameter(D.UNPACK_IMAGE_HEIGHT),Pn=D.getParameter(D.UNPACK_SKIP_PIXELS),kr=D.getParameter(D.UNPACK_SKIP_ROWS),un=D.getParameter(D.UNPACK_SKIP_IMAGES);D.pixelStorei(D.UNPACK_ROW_LENGTH,gt.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,gt.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,Te),D.pixelStorei(D.UNPACK_SKIP_ROWS,De),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Ie),w.isDataTexture||w.isData3DTexture?D.texSubImage3D(Ae,B,Re,Ze,mt,de,ve,we,cn,Qe,gt.data):k.isCompressedArrayTexture?D.compressedTexSubImage3D(Ae,B,Re,Ze,mt,de,ve,we,cn,gt.data):D.texSubImage3D(Ae,B,Re,Ze,mt,de,ve,we,cn,Qe,gt),D.pixelStorei(D.UNPACK_ROW_LENGTH,Dt),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,Je),D.pixelStorei(D.UNPACK_SKIP_PIXELS,Pn),D.pixelStorei(D.UNPACK_SKIP_ROWS,kr),D.pixelStorei(D.UNPACK_SKIP_IMAGES,un),B===0&&k.generateMipmaps&&D.generateMipmap(Ae),Z.unbindTexture()},this.initRenderTarget=function(w){se.get(w).__webglFramebuffer===void 0&&le.setupRenderTarget(w)},this.initTexture=function(w){w.isCubeTexture?le.setTextureCube(w,0):w.isData3DTexture?le.setTexture3D(w,0):w.isDataArrayTexture||w.isCompressedArrayTexture?le.setTexture2DArray(w,0):le.setTexture2D(w,0),Z.unbindTexture()},this.resetState=function(){P=0,C=0,A=null,Z.reset(),He.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return pi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=e===uh?"display-p3":"srgb",n.unpackColorSpace=et.workingColorSpace===dc?"display-p3":"srgb"}}class M_ extends kt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new ei,this.environmentIntensity=1,this.environmentRotation=new ei,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(n.object.environmentIntensity=this.environmentIntensity),n.object.environmentRotation=this.environmentRotation.toArray(),n}}class E_ extends Fr{constructor(e){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new je(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.linewidth=e.linewidth,this.linecap=e.linecap,this.linejoin=e.linejoin,this.fog=e.fog,this}}const Hl=new H,Gl=new H,jm=new ct,aa=new dh,jo=new fc,Eu=new H,Xm=new H;class KC extends kt{constructor(e=new Gn,n=new E_){super(),this.isLine=!0,this.type="Line",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}computeLineDistances(){const e=this.geometry;if(e.index===null){const n=e.attributes.position,i=[0];for(let r=1,s=n.count;r<s;r++)Hl.fromBufferAttribute(n,r-1),Gl.fromBufferAttribute(n,r),i[r]=i[r-1],i[r]+=Hl.distanceTo(Gl);e.setAttribute("lineDistance",new zt(i,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(e,n){const i=this.geometry,r=this.matrixWorld,s=e.params.Line.threshold,a=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),jo.copy(i.boundingSphere),jo.applyMatrix4(r),jo.radius+=s,e.ray.intersectsSphere(jo)===!1)return;jm.copy(r).invert(),aa.copy(e.ray).applyMatrix4(jm);const o=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=o*o,c=this.isLineSegments?2:1,d=i.index,f=i.attributes.position;if(d!==null){const m=Math.max(0,a.start),_=Math.min(d.count,a.start+a.count);for(let x=m,p=_-1;x<p;x+=c){const u=d.getX(x),g=d.getX(x+1),v=Xo(this,e,aa,l,u,g);v&&n.push(v)}if(this.isLineLoop){const x=d.getX(_-1),p=d.getX(m),u=Xo(this,e,aa,l,x,p);u&&n.push(u)}}else{const m=Math.max(0,a.start),_=Math.min(f.count,a.start+a.count);for(let x=m,p=_-1;x<p;x+=c){const u=Xo(this,e,aa,l,x,x+1);u&&n.push(u)}if(this.isLineLoop){const x=Xo(this,e,aa,l,_-1,m);x&&n.push(x)}}}updateMorphTargets(){const n=this.geometry.morphAttributes,i=Object.keys(n);if(i.length>0){const r=n[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,a=r.length;s<a;s++){const o=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[o]=s}}}}}function Xo(t,e,n,i,r,s){const a=t.geometry.attributes.position;if(Hl.fromBufferAttribute(a,r),Gl.fromBufferAttribute(a,s),n.distanceSqToSegment(Hl,Gl,Eu,Xm)>i)return;Eu.applyMatrix4(t.matrixWorld);const l=e.ray.origin.distanceTo(Eu);if(!(l<e.near||l>e.far))return{distance:l,point:Xm.clone().applyMatrix4(t.matrixWorld),index:r,face:null,faceIndex:null,object:t}}const Ym=new H,$m=new H;class ZC extends KC{constructor(e,n){super(e,n),this.isLineSegments=!0,this.type="LineSegments"}computeLineDistances(){const e=this.geometry;if(e.index===null){const n=e.attributes.position,i=[];for(let r=0,s=n.count;r<s;r+=2)Ym.fromBufferAttribute(n,r),$m.fromBufferAttribute(n,r+1),i[r]=r===0?0:i[r-1],i[r+1]=i[r]+Ym.distanceTo($m);e.setAttribute("lineDistance",new zt(i,1))}else console.warn("THREE.LineSegments.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}}class gh extends Gn{constructor(e=1,n=1,i=1,r=32,s=1,a=!1,o=0,l=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:e,radiusBottom:n,height:i,radialSegments:r,heightSegments:s,openEnded:a,thetaStart:o,thetaLength:l};const c=this;r=Math.floor(r),s=Math.floor(s);const d=[],h=[],f=[],m=[];let _=0;const x=[],p=i/2;let u=0;g(),a===!1&&(e>0&&v(!0),n>0&&v(!1)),this.setIndex(d),this.setAttribute("position",new zt(h,3)),this.setAttribute("normal",new zt(f,3)),this.setAttribute("uv",new zt(m,2));function g(){const M=new H,P=new H;let C=0;const A=(n-e)/i;for(let L=0;L<=s;L++){const T=[],y=L/s,N=y*(n-e)+e;for(let z=0;z<=r;z++){const G=z/r,q=G*l+o,Q=Math.sin(q),I=Math.cos(q);P.x=N*Q,P.y=-y*i+p,P.z=N*I,h.push(P.x,P.y,P.z),M.set(Q,A,I).normalize(),f.push(M.x,M.y,M.z),m.push(G,1-y),T.push(_++)}x.push(T)}for(let L=0;L<r;L++)for(let T=0;T<s;T++){const y=x[T][L],N=x[T+1][L],z=x[T+1][L+1],G=x[T][L+1];d.push(y,N,G),d.push(N,z,G),C+=6}c.addGroup(u,C,0),u+=C}function v(M){const P=_,C=new Ge,A=new H;let L=0;const T=M===!0?e:n,y=M===!0?1:-1;for(let z=1;z<=r;z++)h.push(0,p*y,0),f.push(0,y,0),m.push(.5,.5),_++;const N=_;for(let z=0;z<=r;z++){const q=z/r*l+o,Q=Math.cos(q),I=Math.sin(q);A.x=T*I,A.y=p*y,A.z=T*Q,h.push(A.x,A.y,A.z),f.push(0,y,0),C.x=Q*.5+.5,C.y=I*.5*y+.5,m.push(C.x,C.y),_++}for(let z=0;z<r;z++){const G=P+z,q=N+z;M===!0?d.push(q,q+1,G):d.push(q+1,q,G),L+=3}c.addGroup(u,L,M===!0?1:2),u+=L}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new gh(e.radiusTop,e.radiusBottom,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class vh extends Gn{constructor(e=.5,n=1,i=32,r=1,s=0,a=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:e,outerRadius:n,thetaSegments:i,phiSegments:r,thetaStart:s,thetaLength:a},i=Math.max(3,i),r=Math.max(1,r);const o=[],l=[],c=[],d=[];let h=e;const f=(n-e)/r,m=new H,_=new Ge;for(let x=0;x<=r;x++){for(let p=0;p<=i;p++){const u=s+p/i*a;m.x=h*Math.cos(u),m.y=h*Math.sin(u),l.push(m.x,m.y,m.z),c.push(0,0,1),_.x=(m.x/n+1)/2,_.y=(m.y/n+1)/2,d.push(_.x,_.y)}h+=f}for(let x=0;x<r;x++){const p=x*(i+1);for(let u=0;u<i;u++){const g=u+p,v=g,M=g+i+1,P=g+i+2,C=g+1;o.push(v,M,C),o.push(M,P,C)}}this.setIndex(o),this.setAttribute("position",new zt(l,3)),this.setAttribute("normal",new zt(c,3)),this.setAttribute("uv",new zt(d,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new vh(e.innerRadius,e.outerRadius,e.thetaSegments,e.phiSegments,e.thetaStart,e.thetaLength)}}class QC extends Fr{constructor(e){super(),this.isShadowMaterial=!0,this.type="ShadowMaterial",this.color=new je(0),this.transparent=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.fog=e.fog,this}}class w_ extends Fr{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new je(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new je(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=i_,this.normalScale=new Ge(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new ei,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class T_ extends kt{constructor(e,n=1){super(),this.isLight=!0,this.type="Light",this.color=new je(e),this.intensity=n}dispose(){}copy(e,n){return super.copy(e,n),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const n=super.toJSON(e);return n.object.color=this.color.getHex(),n.object.intensity=this.intensity,this.groundColor!==void 0&&(n.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(n.object.distance=this.distance),this.angle!==void 0&&(n.object.angle=this.angle),this.decay!==void 0&&(n.object.decay=this.decay),this.penumbra!==void 0&&(n.object.penumbra=this.penumbra),this.shadow!==void 0&&(n.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(n.object.target=this.target.uuid),n}}const wu=new ct,qm=new H,Km=new H;class JC{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Ge(512,512),this.map=null,this.mapPass=null,this.matrix=new ct,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new ph,this._frameExtents=new Ge(1,1),this._viewportCount=1,this._viewports=[new Tt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const n=this.camera,i=this.matrix;qm.setFromMatrixPosition(e.matrixWorld),n.position.copy(qm),Km.setFromMatrixPosition(e.target.matrixWorld),n.lookAt(Km),n.updateMatrixWorld(),wu.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(wu),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(wu)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class e2 extends JC{constructor(){super(new m_(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Wl extends T_{constructor(e,n){super(e,n),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(kt.DEFAULT_UP),this.updateMatrix(),this.target=new kt,this.shadow=new e2}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class A_ extends T_{constructor(e,n){super(e,n),this.isAmbientLight=!0,this.type="AmbientLight"}}const Zm=new ct;class C_{constructor(e,n,i=0,r=1/0){this.ray=new dh(e,n),this.near=i,this.far=r,this.camera=null,this.layers=new fh,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(e,n){this.ray.set(e,n)}setFromCamera(e,n){n.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(n.matrixWorld),this.ray.direction.set(e.x,e.y,.5).unproject(n).sub(this.ray.origin).normalize(),this.camera=n):n.isOrthographicCamera?(this.ray.origin.set(e.x,e.y,(n.near+n.far)/(n.near-n.far)).unproject(n),this.ray.direction.set(0,0,-1).transformDirection(n.matrixWorld),this.camera=n):console.error("THREE.Raycaster: Unsupported camera type: "+n.type)}setFromXRController(e){return Zm.identity().extractRotation(e.matrixWorld),this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(Zm),this}intersectObject(e,n=!0,i=[]){return af(e,this,i,n),i.sort(Qm),i}intersectObjects(e,n=!0,i=[]){for(let r=0,s=e.length;r<s;r++)af(e[r],this,i,n);return i.sort(Qm),i}}function Qm(t,e){return t.distance-e.distance}function af(t,e,n,i){let r=!0;if(t.layers.test(e.layers)&&t.raycast(e,n)===!1&&(r=!1),r===!0&&i===!0){const s=t.children;for(let a=0,o=s.length;a<o;a++)af(s[a],e,n,!0)}}class t2 extends ZC{constructor(e=10,n=10,i=4473924,r=8947848){i=new je(i),r=new je(r);const s=n/2,a=e/n,o=e/2,l=[],c=[];for(let f=0,m=0,_=-o;f<=n;f++,_+=a){l.push(-o,0,_,o,0,_),l.push(_,0,-o,_,0,o);const x=f===s?i:r;x.toArray(c,m),m+=3,x.toArray(c,m),m+=3,x.toArray(c,m),m+=3,x.toArray(c,m),m+=3}const d=new Gn;d.setAttribute("position",new zt(l,3)),d.setAttribute("color",new zt(c,3));const h=new E_({vertexColors:!0,toneMapped:!1});super(d,h),this.type="GridHelper"}dispose(){this.geometry.dispose(),this.material.dispose()}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:ih}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=ih);function b_(t,e={}){return new w_({color:t,roughness:e.roughness??.75,metalness:e.metalness??.05,...e})}function Pe(t,e,n,i,r=!0){const s=new Or(t,e,n),a=new nn(s,b_(i));return a.castShadow=!0,a.receiveShadow=!0,a.userData.colorable=r,a}function pc(t,e,n,i,r=!1,s=8){const a=new gh(t,e,n,s),o=new nn(a,b_(i));return o.castShadow=!0,o.userData.colorable=r,o}function nr(t,e,n,i,r,s,a=.07){[[e/2-a,r,n/2-a],[-e/2+a,r,n/2-a],[e/2-a,r,-n/2+a],[-e/2+a,r,-n/2+a]].forEach(([l,c,d])=>{const h=pc(.03,.025,i,s,!1);h.position.set(l,c,d),t.add(h)})}function n2(t=9133628){const e=new Ft;e.userData.isFurniture=!0;const n=1.8,i=.85,r=Pe(n,.1,i,2763306,!1);r.position.y=.05,e.add(r);const s=Pe(n-.04,.22,i-.2,t);s.position.set(0,.27,.04),e.add(s);const a=Pe(n-.04,.55,.14,t);a.position.set(0,.615,-.32499999999999996),e.add(a);const o=Pe(.14,.42,i,t);o.position.set(-n/2+.07,.31,0),e.add(o);const l=o.clone();l.position.set(n/2-.07,.31,0),e.add(l);for(let c=-1;c<=1;c++){const d=Pe(.52,.1,.58,t);d.position.set(c*.55,.44,.05),d.scale.set(1,1,1),e.add(d)}for(let c=-1;c<=1;c++){const d=Pe(.52,.38,.1,t);d.position.set(c*.55,.62,-.22499999999999998),e.add(d)}return nr(e,n-.04,i-.04,.1,.05,1710618),e}function i2(t=13940886){const e=new Ft;e.userData.isFurniture=!0;const n=1.3,i=.82,r=Pe(n,.1,i,2763306,!1);r.position.y=.05,e.add(r);const s=Pe(n-.04,.22,i-.2,t);s.position.set(0,.27,.04),e.add(s);const a=Pe(n-.04,.55,.14,t);a.position.set(0,.615,-.30999999999999994),e.add(a);const o=Pe(.14,.42,i,t);o.position.set(-n/2+.07,.31,0),e.add(o);const l=o.clone();l.position.set(n/2-.07,.31,0),e.add(l);for(let c=-.5;c<=.5;c++){const d=Pe(.55,.1,.58,t);d.position.set(c*1.1*.5,.44,.05),e.add(d);const h=Pe(.55,.38,.1,t);h.position.set(c*1.1*.5,.62,-.20999999999999996),e.add(h)}return nr(e,n,i,.1,.05,1710618),e}function r2(t=4860938){const e=new Ft;e.userData.isFurniture=!0;const n=.75,i=.8,r=Pe(n,.08,i,2763306,!1);r.position.y=.04,e.add(r);const s=Pe(n-.04,.2,i-.22,t);s.position.set(0,.24,.04),e.add(s);const a=Pe(n-.04,.55,.12,t);a.position.set(0,.59,-.30000000000000004),e.add(a);const o=Pe(.12,.35,i,t);o.position.set(-n/2+.06,.27,0),e.add(o);const l=o.clone();l.position.set(n/2-.06,.27,0),e.add(l);const c=Pe(n-.26,.08,.5,t);return c.position.set(0,.38,.06),e.add(c),nr(e,n,i,.08,.04,1710618),e}function s2(t=9133628){const e=new Ft;e.userData.isFurniture=!0;const n=1.1,i=.42,r=.55,s=Pe(n,.04,r,t);s.position.y=i-.02,e.add(s);const a=Pe(n-.06,.025,r-.06,t);a.position.y=i*.35,e.add(a);const o=i-.04;return nr(e,n-.06,r-.06,o,i*.5-.01,t,.04),e}function a2(t=9133628){const e=new Ft;e.userData.isFurniture=!0;const n=1.8,i=.76,r=.9,s=Pe(n,.05,r,t);s.position.y=i-.025,e.add(s);const a=i-.05;nr(e,n-.12,r-.12,a,a/2,t,.08);const o=Pe(n-.25,.04,.04,t);return o.position.set(0,a*.3,0),e.add(o),e}function o2(t=4860938){const e=new Ft;e.userData.isFurniture=!0;const n=.45,i=.48,r=.46,s=Pe(n,.06,i,t);s.position.y=r,e.add(s);const a=Pe(n-.04,.05,i-.04,t);a.position.y=r+.055,e.add(a);const o=Pe(n,.36,.04,t);o.position.set(0,r+.38,-.22),e.add(o);const l=Pe(n,.06,.04,t);l.position.set(0,r+.6,-.22),e.add(l);const c=r;return nr(e,n-.04,i-.04,c,c/2,t,.04),e}function l2(t=4860938){const e=new Ft;e.userData.isFurniture=!0;const n=1.6,i=2.1,r=Pe(n,.14,i,t);r.position.y=.07,e.add(r);const s=Pe(n-.06,.22,i-.1,15658734);s.userData.colorable=!1,s.position.y=.25,e.add(s);const a=Pe(n,.65,.1,t);a.position.set(0,.47,-.99),e.add(a);const o=Pe(n,.28,.08,t);o.position.set(0,.28,i/2-.05),e.add(o);for(let l=-.5;l<=.5;l+=1){const c=Pe(.65,.1,.38,16447474);c.userData.colorable=!1,c.position.set(l*.68,.39,-.5),e.add(c)}return nr(e,n,i,.1,.05,1710618),e}function c2(t=16117995){const e=new Ft;e.userData.isFurniture=!0;const n=1.5,i=2,r=.55,s=Pe(n,i,r,t);s.position.y=i/2,e.add(s);const a=n/3-.02;for(let c=-1;c<=1;c++){const d=Pe(a,i-.06,.02,t);d.position.set(c*(n/3),i/2,r/2+.01),e.add(d);const h=pc(.01,.01,.12,11184810,!1);h.rotation.z=Math.PI/2,h.userData.colorable=!1,h.position.set(c*(n/3)+(c>=0?-a/2+.05:a/2-.05),i/2,r/2+.03),e.add(h)}const o=Pe(n,.08,r,2236962,!1);o.position.y=.04,e.add(o);const l=Pe(n,.04,r,t);return l.position.y=i+.02,e.add(l),e}function u2(t=9133628){const e=new Ft;e.userData.isFurniture=!0;const n=.8,i=1.8,r=.3,s=5,a=Pe(.03,i,r,t);a.position.set(-n/2+.015,i/2,0),e.add(a);const o=a.clone();o.position.set(n/2-.015,i/2,0),e.add(o);const l=Pe(n,.03,r,t);l.position.y=i-.015,e.add(l);const c=l.clone();c.position.y=.015,e.add(c);const d=i/(s+1);for(let h=1;h<=s-1;h++){const f=Pe(n-.06,.025,r-.02,t);f.position.y=d*h,e.add(f);const m=[12868646,2908042,4685902,9059210,12092939];let _=-n/2+.06;for(let x=0;x<4;x++){const p=.04+Math.random()*.04,u=.12+Math.random()*.06,g=Pe(p,u,r-.04,m[x%m.length],!1);g.position.set(_+p/2,d*h+.025+u/2,0),e.add(g),_+=p+.005}}return e}function d2(t=16117995){const e=new Ft;e.userData.isFurniture=!0;const n=1.4,i=.75,r=.7,s=Pe(n,.04,r,t);s.position.y=i-.02,e.add(s);const a=Pe(.45,i-.04,r,t);a.position.set(-n/2+.225,(i-.04)/2,0),e.add(a);for(let l=0;l<3;l++){const c=Pe(.41,.14,.02,t);c.position.set(-n/2+.225,.1+l*.18,r/2+.01),e.add(c);const d=Pe(.12,.015,.015,11184810,!1);d.userData.colorable=!1,d.position.set(-n/2+.225,.1+l*.18,r/2+.025),e.add(d)}const o=Pe(.04,i-.04,r,t);return o.position.set(n/2-.02,(i-.04)/2,0),e.add(o),e}function f2(t=4860938){const e=new Ft;e.userData.isFurniture=!0;const n=1.5,i=.5,r=.4,s=Pe(n,i,r,t);s.position.y=i/2,e.add(s);const a=n/2-.04;for(let d=-1;d<=1;d+=2){const h=Pe(a,i-.06,.02,t);h.position.set(d*(n/4),i/2,r/2+.01),e.add(h);const f=pc(.008,.008,.1,11184810,!1);f.rotation.z=Math.PI/2,f.userData.colorable=!1,f.position.set(d*(n/4)-d*.1,i/2,r/2+.025),e.add(f)}const o=Pe(.02,i-.06,r,t);o.position.set(-.02,i/2,0),e.add(o);const l=o.clone();l.position.set(.02,i/2,0),e.add(l);const c=Pe(n-.1,.04,r-.06,1710618,!1);return c.position.y=.02,e.add(c),e}function h2(t=9133628){const e=new Ft;e.userData.isFurniture=!0;const n=.45,i=.58,r=.45,s=Pe(n,.035,r,t);s.position.y=i-.018,e.add(s);const a=Pe(n,.2,r,t);a.position.y=i-.22,e.add(a);const o=Pe(n-.04,.16,.02,t);o.position.set(0,i-.22,r/2+.01),e.add(o);const l=pc(.008,.008,.08,11184810,!1);l.rotation.z=Math.PI/2,l.userData.colorable=!1,l.position.set(0,i-.22,r/2+.025),e.add(l);const c=i-.24;return nr(e,n-.06,r-.06,c,c/2+.02,t,.04),e}function R_(t,e){const i={sofa_3seater:n2,loveseat:i2,armchair:r2,coffee_table:s2,dining_table:a2,dining_chair:o2,bed_queen:l2,wardrobe:c2,bookshelf:u2,office_desk:d2,tv_stand:f2,side_table:h2}[t];if(!i){console.warn(`No builder for ${t}, using fallback box`);const r=new Ft;r.userData.isFurniture=!0;const s=new nn(new Or(1,1,1),new w_({color:e??9133628}));return s.position.y=.5,r.add(s),r}return i(e)}function P_(t,e){t.traverse(n=>{n.isMesh&&n.userData.colorable!==!1&&(n.material=n.material.clone(),n.material.color.setHex(e))})}function Ea(t,e){t.traverse(n=>{n.isMesh&&(n.material._originalEmissive||(n.material._originalEmissive=n.material.emissive.getHex()),n.material.emissive.setHex(e?3355426:n.material._originalEmissive??0))})}function p2(t){return new Promise((e,n)=>{const i=new Image;i.crossOrigin="anonymous",i.onload=()=>e(i),i.onerror=n,i.src=t})}function m2(t,e,n,i){const r=e.width/e.height,s=n/i;let a=0,o=0,l=e.width,c=e.height;r>s?(l=e.height*s,a=(e.width-l)/2):(c=e.width/s,o=(e.height-c)/2),t.drawImage(e,a,o,l,c,0,0,n,i)}function Jm(){const t=U.useRef(null),e=U.useRef(null),n=U.useRef(null),i=U.useRef(null),r=U.useRef(null),s=U.useRef(null),a=U.useRef({}),o=U.useRef(null),l=U.useRef(!1),c=U.useRef(new H),d=U.useRef(new C_),h=U.useRef(new Ge),f=U.useRef(null),{objects:m,selectedId:_,roomImage:x,selectObject:p,removeObject:u,updateTransform:g}=Ur();U.useEffect(()=>{const I=t.current;if(!I)return;const O=I.clientWidth,R=I.clientHeight,V=new S_({canvas:e.current,alpha:!0,antialias:!0,preserveDrawingBuffer:!0});V.setSize(O,R),V.setPixelRatio(Math.min(window.devicePixelRatio,2)),V.shadowMap.enabled=!0,V.shadowMap.type=Wv,V.outputColorSpace=Mn;const Y=new M_,te=new pn(40,O/R,.01,100);te.position.set(0,4.5,7),te.lookAt(0,0,0);const _e=new A_(16775408,.7);Y.add(_e);const be=new Wl(16777215,1);be.position.set(5,10,7),be.castShadow=!0,be.shadow.mapSize.width=2048,be.shadow.mapSize.height=2048,be.shadow.camera.near=.1,be.shadow.camera.far=50,be.shadow.camera.left=-10,be.shadow.camera.right=10,be.shadow.camera.top=10,be.shadow.camera.bottom=-10,Y.add(be);const $=new Wl(13162751,.4);$.position.set(-5,3,-5),Y.add($);const ae=new eo(30,30),pe=new QC({opacity:.25}),he=new nn(ae,pe);he.rotation.x=-Math.PI/2,he.receiveShadow=!0,he.name="ground",Y.add(he),s.current=he;const Le=new t2(20,40,4473941,2763322);Le.material.opacity=.25,Le.material.transparent=!0,Y.add(Le),i.current=Y,n.current=V,r.current=te;const Fe=()=>{f.current=requestAnimationFrame(Fe),V.render(Y,te)};Fe();const ke=()=>{const it=I.clientWidth,D=I.clientHeight;te.aspect=it/D,te.updateProjectionMatrix(),V.setSize(it,D)};return window.addEventListener("resize",ke),()=>{cancelAnimationFrame(f.current),V.dispose(),window.removeEventListener("resize",ke)}},[]),U.useEffect(()=>{const I=i.current,O=a.current;if(!I)return;m.forEach(V=>{if(!O[V.id]){const Y=R_(V.furnitureId,V.colorHex);Y.userData.sceneObjId=V.id,Y.userData.isFurniture=!0,Y.position.set((Math.random()-.5)*2,0,(Math.random()-.5)*2),I.add(Y),O[V.id]=Y}});const R=new Set(m.map(V=>V.id));Object.keys(O).forEach(V=>{R.has(V)||(I.remove(O[V]),delete O[V])}),Object.entries(O).forEach(([V,Y])=>{Ea(Y,V===_)})},[m,_]),U.useEffect(()=>{m.forEach(I=>{const O=a.current[I.id];O&&(P_(O,I.colorHex),Ea(O,I.id===_))})},[m.map(I=>`${I.id}:${I.colorHex}`).join(",")]);const v=U.useCallback(I=>{const O=e.current.getBoundingClientRect();h.current.x=(I.clientX-O.left)/O.width*2-1,h.current.y=-((I.clientY-O.top)/O.height)*2+1},[]),M=U.useCallback(I=>{v(I),d.current.setFromCamera(h.current,r.current);const O=d.current.intersectObject(s.current);return O.length>0?O[0].point:null},[v]),P=U.useCallback(I=>{v(I),d.current.setFromCamera(h.current,r.current);const O=Object.values(a.current),R=d.current.intersectObjects(O,!0);if(R.length===0)return null;let V=R[0].object;for(;V.parent&&!V.userData.isFurniture;)V=V.parent;return V.userData.isFurniture?V:null},[v]),C=U.useCallback(I=>{if(I.button!==0)return;const O=P(I);if(O){const R=O.userData.sceneObjId;p(R),o.current=R,l.current=!0,e.current.classList.add("dragging");const V=M(I);V&&(c.current.copy(O.position).sub(V),c.current.y=0)}else p(null),o.current=null},[P,M,p]),A=U.useCallback(I=>{if(!l.current||!o.current)return;const O=M(I);if(!O)return;const R=a.current[o.current];R&&R.position.set(O.x+c.current.x,R.position.y,O.z+c.current.z)},[M]),L=U.useCallback(()=>{var I;l.current=!1,(I=e.current)==null||I.classList.remove("dragging")},[]),T=U.useCallback(I=>{if(I.preventDefault(),!o.current)return;const O=a.current[o.current];if(!O)return;const R=I.deltaY>0?.95:1.05;O.scale.multiplyScalar(R);const V=Math.max(.1,Math.min(5,O.scale.x));O.scale.set(V,V,V)},[]);U.useEffect(()=>{const I=O=>{if(!o.current)return;const R=a.current[o.current];if(!R)return;const V=Math.PI/12;(O.key==="r"||O.key==="R")&&(R.rotation.y+=V),O.key==="ArrowLeft"&&(O.preventDefault(),R.rotation.y-=V),O.key==="ArrowRight"&&(O.preventDefault(),R.rotation.y+=V),(O.key==="Delete"||O.key==="Backspace")&&(O.preventDefault(),u(o.current),o.current=null)};return window.addEventListener("keydown",I),()=>window.removeEventListener("keydown",I)},[u]);const y=U.useRef({x:0,y:0}),N=U.useRef("none"),z=U.useRef(0),G=U.useCallback(I=>{if(I.touches.length===1){const O=I.touches[0],R={clientX:O.clientX,clientY:O.clientY,button:0};C(R),y.current={x:O.clientX,y:O.clientY},N.current="drag"}else if(I.touches.length===2){N.current="pinch";const O=I.touches[0].clientX-I.touches[1].clientX,R=I.touches[0].clientY-I.touches[1].clientY;z.current=Math.hypot(O,R)}},[C]),q=U.useCallback(I=>{if(I.preventDefault(),N.current==="drag"&&I.touches.length===1){const O=I.touches[0];A({clientX:O.clientX,clientY:O.clientY})}else if(N.current==="pinch"&&I.touches.length===2){if(!o.current)return;const O=I.touches[0].clientX-I.touches[1].clientX,R=I.touches[0].clientY-I.touches[1].clientY,V=Math.hypot(O,R),Y=V/z.current;z.current=V;const te=a.current[o.current];if(te){const _e=Math.max(.1,Math.min(5,te.scale.x*Y));te.scale.set(_e,_e,_e)}}},[A]),Q=U.useCallback(()=>{L(),N.current="none"},[L]);return U.useEffect(()=>(window.__arRotate=I=>{if(!o.current)return;const O=a.current[o.current];O&&(O.rotation.y+=I*Math.PI/180)},window.__arScale=I=>{if(!o.current)return;const O=a.current[o.current];if(O){const R=Math.max(.1,Math.min(5,O.scale.x*I));O.scale.set(R,R,R)}},window.__saveLayoutPicture=async()=>{const I=n.current,O=i.current,R=r.current,V=e.current;if(!I||!O||!R||!V)throw new Error("Viewer is not ready yet.");I.render(O,R);const Y=document.createElement("canvas");Y.width=V.width,Y.height=V.height;const te=Y.getContext("2d");if(!te)throw new Error("Could not prepare image export.");if(x){const $=await p2(x);m2(te,$,Y.width,Y.height)}else{const $=te.createLinearGradient(0,0,0,Y.height);$.addColorStop(0,"#1a1a28"),$.addColorStop(.6,"#22222e"),$.addColorStop(1,"#2a2a3a"),te.fillStyle=$,te.fillRect(0,0,Y.width,Y.height)}te.drawImage(V,0,0,Y.width,Y.height);const _e=Y.toDataURL("image/png"),be=document.createElement("a");be.href=_e,be.download=`ar-layout-${Date.now()}.png`,be.click()},()=>{delete window.__arRotate,delete window.__arScale,delete window.__saveLayoutPicture}),[x]),S.jsxs("div",{ref:t,className:"relative w-full h-full overflow-hidden rounded-2xl",children:[x?S.jsx("img",{src:x,alt:"Room",className:"absolute inset-0 w-full h-full object-cover",style:{filter:"brightness(0.88) saturate(0.9)"}}):S.jsx("div",{className:"absolute inset-0",style:{background:"linear-gradient(180deg, #1a1a28 0%, #22222e 60%, #2a2a3a 100%)",backgroundImage:`
              linear-gradient(rgba(212,165,116,0.04) 1px, transparent 1px),
              linear-gradient(90deg, rgba(212,165,116,0.04) 1px, transparent 1px)
            `,backgroundSize:"80px 80px"}}),S.jsx("canvas",{id:"ar-canvas",ref:e,className:"absolute inset-0 w-full h-full",onMouseDown:C,onMouseMove:A,onMouseUp:L,onMouseLeave:L,onWheel:T,onTouchStart:G,onTouchMove:q,onTouchEnd:Q,style:{touchAction:"none"}}),m.length===0&&S.jsx("div",{className:"absolute inset-0 flex flex-col items-center justify-center pointer-events-none",children:S.jsxs("div",{className:"glass-card px-8 py-6 text-center max-w-sm",children:[S.jsx("div",{className:"text-5xl mb-3 animate-float",children:"🛋️"}),S.jsx("p",{className:"text-text-primary font-display text-lg mb-1",children:"Your Room, Your Style"}),S.jsxs("p",{className:"text-text-secondary text-sm",children:["Select furniture from the sidebar, then click ",S.jsx("span",{className:"text-accent",children:'"Add to Scene"'})]})]})}),m.length>0&&S.jsx("div",{className:"absolute bottom-4 left-1/2 -translate-x-1/2 pointer-events-none",children:S.jsxs("div",{className:"bg-black/70 backdrop-blur-sm text-text-secondary text-xs px-4 py-2 rounded-full flex gap-4",children:[S.jsx("span",{children:"🖱️ Drag to move"}),S.jsx("span",{children:"🖱️ Scroll to scale"}),S.jsx("span",{children:"⌨️ R / ← / → to rotate"}),S.jsx("span",{children:"⌨️ Del to remove"})]})})]})}function g2(){const t=new vh(.12,.15,32);t.applyMatrix4(new ct().makeRotationX(-Math.PI/2));const e=new hh({color:13935988,side:qn}),n=new nn(t,e);return n.visible=!1,n.matrixAutoUpdate=!1,n}function eg(){const[t,e]=U.useState(null),[n,i]=U.useState("idle"),[r,s]=U.useState(""),a=U.useRef(null),o=U.useRef(null),l=U.useRef(null),c=U.useRef(null),d=U.useRef(null),h=U.useRef(null),f=U.useRef(null),m=U.useRef(null),_=U.useRef(null),x=U.useRef(null),p=U.useRef(null),u=U.useRef(null),g=U.useRef({}),v=U.useRef(null),M=U.useRef(null),P=U.useRef(null),C=U.useRef(new C_),A=U.useRef(new Ge),L=U.useRef(null),T=U.useRef(new Set),{objects:y,selectedId:N,selectObject:z,removeObject:G,setRoomImage:q,setARMode:Q}=Ur();U.useEffect(()=>{L.current=N},[N]),U.useEffect(()=>{T.current=new Set(y.map(K=>K.id))},[]),U.useEffect(()=>{if(!navigator.xr){e(!1);return}navigator.xr.isSessionSupported("immersive-ar").then(K=>e(K)).catch(()=>e(!1))},[]);const I=U.useCallback(()=>{f.current&&(f.current.setAnimationLoop(null),f.current.dispose(),f.current=null),P.current&&(window.removeEventListener("resize",P.current),P.current=null),cancelAnimationFrame(M.current),M.current=null,m.current=null,_.current=null,u.current=null,p.current=null,g.current={}},[]),O=U.useCallback(()=>{var K;(K=v.current)==null||K.getTracks().forEach(Z=>Z.stop()),v.current=null,l.current&&(l.current.pause(),l.current.srcObject=null)},[]),R=U.useCallback(async()=>{const K=x.current;if(x.current=null,K)try{await K.end()}catch{}O(),I(),i("idle")},[I,O]);U.useEffect(()=>()=>{R()},[R]);const V=U.useCallback(({enableXR:K=!1}={})=>{const Z=o.current,xe=a.current;if(!Z||!xe)throw new Error("Camera surface is not ready yet.");I();const se=new S_({canvas:Z,alpha:!0,antialias:!0,preserveDrawingBuffer:!0});se.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),se.outputColorSpace=Mn,se.shadowMap.enabled=!0,se.xr.enabled=K;const le=new M_;le.add(new A_(16777215,1.2));const b=new Wl(16777215,1.2);b.position.set(1.5,3,2),b.castShadow=!0,le.add(b);const E=new Wl(14017791,.4);E.position.set(-2,1,.5),le.add(E);const W=new pn(60,1,.01,30);W.position.set(0,0,0),W.lookAt(0,0,-1);const ie=()=>{const re=xe.clientWidth||window.innerWidth,J=xe.clientHeight||window.innerHeight;!re||!J||(se.setSize(re,J,!1),W.aspect=re/J,W.updateProjectionMatrix())};return ie(),window.addEventListener("resize",ie),P.current=ie,m.current=le,_.current=W,f.current=se,{renderer:se,scene:le,camera:W}},[I]),Y=U.useCallback(K=>{const Z=g.current;y.forEach(se=>{if(!Z[se.id]){const le=R_(se.furnitureId,se.colorHex);le.userData.sceneObjId=se.id,le.userData.isFurniture=!0,le.visible=!1,K.add(le),Z[se.id]=le}});const xe=new Set(y.map(se=>se.id));Object.keys(Z).forEach(se=>{xe.has(se)||(K==null||K.remove(Z[se]),delete Z[se])})},[y]);U.useEffect(()=>{const K=m.current;K&&Y(K)},[Y]),U.useEffect(()=>{y.forEach(K=>{const Z=g.current[K.id];Z&&(P_(Z,K.colorHex),Ea(Z,K.id===N))})},[y,N]);const te=U.useCallback(()=>{var Z;const K=L.current||((Z=y[0])==null?void 0:Z.id)||null;return K?{id:K,mesh:g.current[K]||null}:null},[y]),_e=U.useCallback((K,Z)=>{var se;const xe=(se=o.current)==null?void 0:se.getBoundingClientRect();return xe?(A.current.x=(K-xe.left)/xe.width*2-1,A.current.y=-((Z-xe.top)/xe.height)*2+1,!0):!1},[]),be=U.useCallback((K,Z)=>{if(!_e(K,Z)||!_.current)return null;C.current.setFromCamera(A.current,_.current);const xe=Object.values(g.current).filter(b=>b.visible),se=C.current.intersectObjects(xe,!0);if(!se.length)return null;let le=se[0].object;for(;le.parent&&!le.userData.isFurniture;)le=le.parent;return le.userData.isFurniture?le:null},[_e]),$=U.useCallback((K,Z,xe=2.4)=>{if(!_e(K,Z)||!_.current)return null;const se=_.current,b=new H(A.current.x,A.current.y,.5).unproject(se).sub(se.position).normalize();if(Math.abs(b.z)<1e-4)return null;const W=(-xe-se.position.z)/b.z;return se.position.clone().add(b.multiplyScalar(W))},[_e]),ae=U.useCallback((K,Z)=>{const xe=te();if(!(xe!=null&&xe.mesh))return;const se=xe.mesh,le=$(K,Z);if(!le)return;const b=new Lr().setFromObject(se),E=Number.isFinite(b.min.y)?-b.min.y:0;se.visible=!0,se.position.set(le.x,le.y+E,le.z),se.rotation.x=0,se.rotation.z=0,z(xe.id),Ea(se,!0)},[te,$,z]),pe=U.useCallback((K,Z=0)=>{if(!K)return;const xe=[-.6,0,.6,-1.1,1.1],se=new Lr().setFromObject(K),le=Number.isFinite(se.min.y)?-se.min.y:0;K.visible=!0,K.position.set(xe[Z]??0,-.45+le,-2.2),K.scale.x===1&&K.scale.y===1&&K.scale.z===1&&K.scale.setScalar(.9)},[]),he=U.useCallback(K=>{if(n!=="live")return;const Z=K.clientX,xe=K.clientY;if(typeof Z!="number"||typeof xe!="number")return;const se=be(Z,xe);if(se){const le=se.userData.sceneObjId;z(le);return}ae(Z,xe)},[be,n,ae,z]);U.useEffect(()=>{if(n!=="live")return;const K=T.current;y.filter(xe=>!K.has(xe.id)).forEach((xe,se)=>{const le=g.current[xe.id];le&&(pe(le,se),z(xe.id))}),T.current=new Set(y.map(xe=>xe.id))},[n,y,pe,z]);const Le=U.useCallback(async()=>{s(""),i("starting-live");try{const K=await navigator.mediaDevices.getUserMedia({audio:!1,video:{facingMode:{ideal:"environment"},width:{ideal:1920},height:{ideal:1080}}});if(v.current=K,!l.current)throw new Error("Video preview is not ready yet.");l.current.srcObject=K,await l.current.play();const{renderer:Z,scene:xe,camera:se}=V();Y(xe);const le=te();le!=null&&le.mesh&&pe(le.mesh,1);const b=()=>{M.current=requestAnimationFrame(b),Z.render(xe,se)};b(),i("live")}catch(K){O(),I(),i("error"),s((K==null?void 0:K.message)||"Could not start the live camera.")}},[I,te,pe,V,O,Y]),Fe=U.useCallback(async()=>{if(!t){i("error"),s("Surface AR is not supported on this phone/browser.");return}s(""),i("starting-webxr");try{const{renderer:K,scene:Z,camera:xe}=V({enableXR:!0});Y(Z);const se=g2();Z.add(se),u.current=se;const le=await navigator.xr.requestSession("immersive-ar",{requiredFeatures:["hit-test"],optionalFeatures:["dom-overlay","light-estimation"],domOverlay:c.current?{root:c.current}:void 0});x.current=le,K.xr.setReferenceSpaceType("local"),await K.xr.setSession(le);const b=await le.requestReferenceSpace("local"),E=await le.requestReferenceSpace("viewer"),W=await le.requestHitTestSource({space:E});p.current=W,le.addEventListener("select",()=>{const ie=te(),re=ie==null?void 0:ie.mesh,J=u.current;!re||!(J!=null&&J.visible)||(re.visible=!0,re.position.setFromMatrixPosition(J.matrix),re.quaternion.setFromRotationMatrix(J.matrix),re.rotation.x=0,re.rotation.z=0,z(ie.id),Ea(re,!0))}),le.addEventListener("end",()=>{x.current=null,I(),i("idle")}),K.setAnimationLoop((ie,re)=>{if(!re)return;const J=re.getHitTestResults(W);if(J.length>0){const Ce=J[0].getPose(b);Ce&&u.current&&(u.current.visible=!0,u.current.matrix.fromArray(Ce.transform.matrix))}else u.current&&(u.current.visible=!1);K.render(Z,K.xr.getCamera(xe))}),i("webxr")}catch(K){I(),i("error"),s((K==null?void 0:K.message)||"Could not start surface AR.")}},[t,I,te,z,V]),ke=U.useCallback(K=>{const Z=te();Z!=null&&Z.mesh&&(Z.mesh.rotation.y+=K*Math.PI/180)},[te]),it=U.useCallback(K=>{const Z=te();if(!(Z!=null&&Z.mesh))return;const xe=Math.max(.15,Math.min(4,Z.mesh.scale.x*K));Z.mesh.scale.setScalar(xe)},[te]),D=U.useCallback(()=>{const K=L.current;K&&(G(K),z(null))},[G,z]),ut=U.useCallback(K=>{if(!K)return;const Z=new FileReader;Z.onload=xe=>{var se;q(((se=xe.target)==null?void 0:se.result)||null),Q(!1)},Z.readAsDataURL(K)},[Q,q]),Ye=n==="live"||n==="webxr";return S.jsxs("div",{ref:a,className:"relative h-full w-full overflow-hidden bg-bg-primary",children:[S.jsx("video",{ref:l,className:`absolute inset-0 h-full w-full object-cover ${n==="live"?"block":"hidden"}`,autoPlay:!0,muted:!0,playsInline:!0}),S.jsx("canvas",{ref:o,className:`absolute inset-0 h-full w-full ${Ye?"block":"hidden"}`,onPointerDown:he,style:{touchAction:"none"}}),S.jsx("input",{ref:d,type:"file",accept:"image/*",className:"hidden",onChange:K=>{var Z;return ut((Z=K.target.files)==null?void 0:Z[0])}}),S.jsx("input",{ref:h,type:"file",accept:"image/*",capture:"environment",className:"hidden",onChange:K=>{var Z;return ut((Z=K.target.files)==null?void 0:Z[0])}}),!Ye&&S.jsx("div",{className:"absolute inset-0 overflow-y-auto custom-scroll",children:S.jsxs("div",{className:"flex min-h-full flex-col items-center justify-center gap-5 px-4 py-6 text-center sm:px-8",children:[S.jsx("div",{className:"text-5xl animate-float",children:"📱"}),S.jsxs("div",{className:"max-w-sm space-y-2",children:[S.jsx("h3",{className:"font-display text-2xl text-text-primary",children:"Mobile AR Tools"}),S.jsx("p",{className:"text-sm text-text-secondary",children:"Use live camera mode for quick placement, or launch surface AR on supported phones for real-world hit testing."})]}),S.jsxs("div",{className:"grid w-full max-w-sm gap-3",children:[S.jsxs("button",{onClick:Le,disabled:n==="starting-live",className:"btn-primary flex items-center justify-center gap-2 px-5 py-4 text-base",children:[S.jsx(SM,{size:18}),n==="starting-live"?"Starting Live Camera…":"Start Live Camera"]}),S.jsxs("button",{onClick:Fe,disabled:!t||n==="starting-webxr",className:"btn-secondary flex items-center justify-center gap-2 px-5 py-4 text-base disabled:opacity-50",children:[S.jsx(UM,{size:18}),n==="starting-webxr"?"Starting Surface AR…":t?"Launch Surface AR":"Surface AR Not Supported"]})]}),S.jsxs("div",{className:"grid w-full max-w-sm grid-cols-1 gap-3 sm:grid-cols-2",children:[S.jsxs("button",{onClick:()=>{var K;return(K=h.current)==null?void 0:K.click()},className:"btn-secondary flex items-center justify-center gap-2 px-4 py-3 text-sm",children:[S.jsx(RM,{size:16}),"Take Room Photo"]}),S.jsxs("button",{onClick:()=>{var K;return(K=d.current)==null?void 0:K.click()},className:"btn-secondary flex items-center justify-center gap-2 px-4 py-3 text-sm",children:[S.jsx(kM,{size:16}),"Upload From Device"]})]}),S.jsxs("div",{className:"glass-card w-full max-w-sm px-4 py-3 text-left",children:[S.jsx("p",{className:"text-xs font-semibold uppercase tracking-[0.2em] text-accent",children:"How to use"}),S.jsx("p",{className:"mt-2 text-sm text-text-secondary",children:"1. Add furniture from the catalog below."}),S.jsx("p",{className:"text-sm text-text-secondary",children:"2. Select an item, then start live camera or surface AR."}),S.jsx("p",{className:"text-sm text-text-secondary",children:"3. Tap on the screen to place or reposition the selected item."})]}),n==="error"&&S.jsx("p",{className:"max-w-sm text-sm text-error",children:r})]})}),S.jsxs("div",{ref:c,className:`ar-overlay ${Ye?"":"hidden"}`,children:[S.jsxs("div",{className:"absolute left-0 right-0 top-0 flex items-start justify-between gap-3 p-3 sm:p-4",children:[S.jsxs("div",{className:"max-w-[70%] rounded-2xl bg-black/65 px-4 py-2 backdrop-blur-sm",children:[S.jsx("p",{className:"text-xs uppercase tracking-[0.2em] text-white/50",children:n==="webxr"?"Surface AR":"Live Camera"}),S.jsx("p",{className:"text-sm text-white",children:y.length===0?"Add furniture from the catalog below first.":"Tap anywhere to place the selected furniture."})]}),S.jsx("button",{onClick:R,className:"rounded-2xl bg-black/65 p-3 text-white backdrop-blur-sm hover:bg-black/80",children:S.jsx(zM,{size:18})})]}),y.length>0&&S.jsx("div",{className:"absolute bottom-24 left-3 right-3 sm:left-4 sm:right-4",children:S.jsxs("div",{className:"rounded-2xl bg-black/70 p-3 backdrop-blur-sm",children:[S.jsx("p",{className:"mb-2 px-1 text-xs text-white/60",children:"Selected furniture"}),S.jsx("div",{className:"flex gap-2 overflow-x-auto pb-1 custom-scroll",children:y.map(K=>{const Z=Ds.find(se=>se.id===K.furnitureId),xe=N===K.id;return S.jsxs("button",{onClick:()=>z(K.id),className:`flex min-w-[92px] flex-shrink-0 flex-col items-center gap-1 rounded-xl border px-3 py-2 transition-all ${xe?"border-accent bg-accent/25 text-white":"border-white/20 text-white/70"}`,children:[S.jsx("span",{className:"text-xl",children:(Z==null?void 0:Z.emoji)||K.emoji}),S.jsx("span",{className:"text-xs",children:(Z==null?void 0:Z.name)||K.name})]},K.id)})})]})}),N&&S.jsx("div",{className:"absolute bottom-4 left-3 right-3 sm:left-4 sm:right-4",children:S.jsxs("div",{className:"flex items-center justify-center gap-3",children:[S.jsx("button",{onClick:()=>ke(-45),className:"rounded-xl border border-white/20 bg-black/70 p-3 text-white hover:bg-black/90",children:S.jsx(Md,{size:18})}),S.jsx("button",{onClick:()=>it(.9),className:"rounded-xl border border-white/20 bg-black/70 p-3 text-white hover:bg-black/90",children:S.jsx(Sd,{size:18})}),S.jsx("button",{onClick:()=>it(1.1),className:"rounded-xl border border-white/20 bg-black/70 p-3 text-white hover:bg-black/90",children:S.jsx(Ul,{size:18})}),S.jsx("button",{onClick:()=>ke(45),className:"rounded-xl border border-white/20 bg-black/70 p-3 text-white hover:bg-black/90",children:S.jsx(Ed,{size:18})}),S.jsx("button",{onClick:D,className:"rounded-xl border border-error/30 bg-error/20 p-3 text-error hover:bg-error/30",children:S.jsx(wd,{size:18})})]})}),n==="live"&&S.jsx("div",{className:"absolute inset-x-0 top-1/2 flex -translate-y-1/2 justify-center pointer-events-none",children:S.jsx("div",{className:"rounded-full bg-black/40 px-4 py-1 text-xs text-white/80 backdrop-blur-sm",children:"Tap anywhere in the camera view to place the selected item"})})]})]})}function oi({icon:t,label:e,onClick:n,variant:i="default",small:r}){const s=`flex items-center justify-center rounded-lg transition-all duration-200 active:scale-90 ${r?"w-8 h-8":"w-9 h-9"}`,a={default:"bg-bg-elevated hover:bg-border text-text-secondary hover:text-text-primary border border-border",accent:"bg-accent/10 hover:bg-accent/20 text-accent border border-accent/20",danger:"bg-error/10 hover:bg-error/20 text-error border border-error/20"};return S.jsx("button",{title:e,onClick:n,className:`${s} ${a[i]}`,children:S.jsx(t,{size:r?13:15})})}function tg(){const[t,e]=U.useState(!1),{objects:n,selectedId:i,selectedObject:r,selectObject:s,removeObject:a,resetScene:o,isARMode:l}=Ur(),c=f=>{typeof window.__arRotate=="function"&&window.__arRotate(f)},d=f=>{typeof window.__arScale=="function"&&window.__arScale(f)},h=async()=>{if(typeof window.__saveLayoutPicture=="function"){e(!0);try{await window.__saveLayoutPicture()}catch(f){window.alert((f==null?void 0:f.message)||"Could not save the layout picture.")}finally{e(!1)}}};return S.jsxs("aside",{className:"w-full lg:w-56 flex-shrink-0 flex flex-col h-full bg-bg-secondary lg:border-l border-border min-w-0",children:[S.jsx("div",{className:"px-4 pt-4 pb-3 border-b border-border",children:S.jsxs("div",{className:"flex items-center justify-between",children:[S.jsxs("div",{className:"flex items-center gap-2",children:[S.jsx(PM,{size:15,className:"text-accent"}),S.jsx("h2",{className:"font-display text-base text-text-primary",children:"Scene"})]}),S.jsx("span",{className:"badge badge-accent text-[10px]",children:n.length})]})}),S.jsx("div",{className:"flex-1 overflow-y-auto custom-scroll p-3 space-y-1.5",children:n.length===0?S.jsxs("div",{className:"text-center py-8",children:[S.jsx("div",{className:"text-2xl mb-2",children:"🏠"}),S.jsx("p",{className:"text-text-muted text-xs",children:"No furniture added yet"}),S.jsx("p",{className:"text-text-muted text-xs",children:'Click "Add to Scene" from the catalog'})]}):n.map((f,m)=>{const _=Ds.find(p=>p.id===f.furnitureId),x=i===f.id;return S.jsxs("div",{className:`scene-item ${x?"selected":""}`,onClick:()=>s(f.id),children:[S.jsx("span",{className:"text-lg flex-shrink-0",children:f.emoji||(_==null?void 0:_.emoji)||"📦"}),S.jsxs("div",{className:"flex-1 min-w-0",children:[S.jsx("p",{className:"text-text-primary text-xs font-medium truncate",children:f.name}),S.jsxs("p",{className:"text-text-muted text-[10px]",children:["Item ",m+1]})]}),S.jsx("button",{onClick:p=>{p.stopPropagation(),a(f.id)},className:"text-text-muted hover:text-error transition-colors p-1 rounded",children:S.jsx(wd,{size:12})})]},f.id)})}),r&&S.jsxs("div",{className:"border-t border-border p-3 space-y-3",children:[S.jsxs("p",{className:"text-text-muted text-xs font-medium",children:["Transform: ",r.name]}),S.jsxs("div",{children:[S.jsx("p",{className:"text-text-muted text-[10px] mb-1.5",children:"Rotate"}),S.jsxs("div",{className:"flex gap-1.5",children:[S.jsx(oi,{icon:Md,label:"Rotate -45°",onClick:()=>c(-45),small:!0}),S.jsx(oi,{icon:Md,label:"Rotate -90°",onClick:()=>c(-90),small:!0}),S.jsx(oi,{icon:Ed,label:"Rotate +90°",onClick:()=>c(90),small:!0}),S.jsx(oi,{icon:Ed,label:"Rotate +45°",onClick:()=>c(45),small:!0})]})]}),S.jsxs("div",{children:[S.jsx("p",{className:"text-text-muted text-[10px] mb-1.5",children:"Scale"}),S.jsxs("div",{className:"flex gap-1.5",children:[S.jsx(oi,{icon:Sd,label:"Shrink",onClick:()=>d(.9),small:!0}),S.jsx(oi,{icon:Sd,label:"Shrink more",onClick:()=>d(.75),small:!0}),S.jsx(oi,{icon:Ul,label:"Grow",onClick:()=>d(1.1),small:!0}),S.jsx(oi,{icon:Ul,label:"Grow more",onClick:()=>d(1.25),small:!0})]})]}),S.jsx(oi,{icon:wd,label:"Delete",variant:"danger",onClick:()=>a(i)})]}),n.length>0&&S.jsxs("div",{className:"px-3 pb-3 border-t border-border pt-2",children:[!l&&S.jsxs("button",{onClick:h,disabled:t,className:"w-full mb-2 flex items-center justify-center gap-2 text-text-primary text-xs py-2 rounded-xl bg-accent/10 hover:bg-accent/20 border border-accent/20 transition-all disabled:opacity-60 disabled:cursor-not-allowed",children:[S.jsx(AM,{size:12}),t?"Saving picture…":"Save Layout Picture"]}),S.jsxs("button",{onClick:()=>{window.confirm("Clear all furniture from the scene?")&&o()},className:"w-full flex items-center justify-center gap-2 text-text-muted hover:text-error text-xs py-2 rounded-xl hover:bg-error/5 transition-all border border-transparent hover:border-error/20",children:[S.jsx(IM,{size:12}),"Reset Scene"]})]})]})}function v2(){var s;const{selectedObject:t,selectedId:e,updateColor:n}=Ur();if(!t)return S.jsxs("div",{className:"flex items-center gap-2 text-text-muted text-sm px-4 py-3",children:[S.jsx(Xp,{size:15}),S.jsx("span",{children:"Select a furniture item to change colors"})]});const i=Ds.find(a=>a.id===t.furnitureId),r=(i==null?void 0:i.colors)||Object.keys(Ms);return S.jsxs("div",{className:"flex items-center gap-3 px-4 py-2",children:[S.jsxs("div",{className:"flex items-center gap-1.5 text-text-secondary text-xs flex-shrink-0",children:[S.jsx(Xp,{size:14}),S.jsx("span",{children:"Color:"})]}),S.jsx("div",{className:"flex items-center gap-2 flex-wrap",children:r.map(a=>{const o=Ms[a];return o?S.jsx("button",{title:o.label,onClick:()=>n(e,a),className:`color-swatch ${t.colorKey===a?"active":""}`,style:{backgroundColor:o.hex}},a):null})}),S.jsx("span",{className:"text-text-muted text-xs ml-1",children:((s=Ms[t.colorKey])==null?void 0:s.label)||""})]})}function _2(){var d;const{user:t,logout:e}=cc(),{isARMode:n,setARMode:i,setRoomImage:r}=Ur(),s=lc(),[a,o]=U.useState(!1),l=()=>{e(),s("/")},c=h=>{var _;const f=(_=h.target.files)==null?void 0:_[0];if(!f)return;const m=new FileReader;m.onload=x=>r(x.target.result),m.readAsDataURL(f),i(!1)};return S.jsxs("header",{className:"flex-shrink-0 flex flex-wrap items-center justify-between gap-3 px-3 py-3 sm:px-4 bg-bg-secondary border-b border-border z-20",children:[S.jsxs("div",{className:"flex items-center gap-2.5 min-w-0",children:[S.jsx("span",{className:"text-2xl",children:"🛋️"}),S.jsxs("div",{children:[S.jsx("h1",{className:"font-display text-base text-text-primary leading-none",children:"AR Visualizer"}),S.jsx("p",{className:"text-text-muted text-[10px]",children:"Furniture in Your Space"})]})]}),S.jsxs("div",{className:"order-3 w-full sm:order-none sm:w-auto flex items-center gap-1 bg-bg-elevated rounded-xl p-1 border border-border overflow-x-auto custom-scroll",children:[S.jsxs("button",{onClick:()=>i(!1),className:`flex-1 sm:flex-none items-center justify-center flex gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all whitespace-nowrap ${n?"text-text-secondary hover:text-text-primary":"bg-accent text-bg-primary"}`,children:[S.jsx(DM,{size:13}),"Desktop"]}),S.jsxs("button",{onClick:()=>i(!0),className:`flex-1 sm:flex-none items-center justify-center flex gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all whitespace-nowrap ${n?"bg-accent text-bg-primary":"text-text-secondary hover:text-text-primary"}`,children:[S.jsx(OM,{size:13}),"Mobile AR"]})]}),S.jsxs("div",{className:"flex items-center gap-2 ml-auto",children:[!n&&S.jsxs("label",{className:"btn-secondary text-xs px-3 py-1.5 cursor-pointer whitespace-nowrap",children:["📷 Upload Room Photo",S.jsx("input",{type:"file",accept:"image/*",onChange:c,className:"hidden"})]}),S.jsxs("div",{className:"relative",children:[S.jsxs("button",{onClick:()=>o(h=>!h),className:"flex items-center gap-2 bg-bg-elevated hover:bg-border border border-border rounded-xl px-3 py-1.5 transition-all",children:[S.jsx("div",{className:"w-6 h-6 rounded-full bg-accent/20 flex items-center justify-center",children:S.jsx(Hv,{size:13,className:"text-accent"})}),S.jsx("span",{className:"text-text-primary text-xs font-medium hidden sm:block",children:(t==null?void 0:t.name)||((d=t==null?void 0:t.email)==null?void 0:d.split("@")[0])||"User"}),S.jsx(EM,{size:12,className:"text-text-muted"})]}),a&&S.jsxs("div",{className:"absolute right-0 top-full mt-2 w-48 glass-card shadow-card py-1 z-50",children:[S.jsxs("div",{className:"px-4 py-2 border-b border-border",children:[S.jsx("p",{className:"text-text-primary text-sm font-medium",children:(t==null?void 0:t.name)||"User"}),S.jsx("p",{className:"text-text-muted text-xs truncate",children:t==null?void 0:t.email})]}),S.jsxs("button",{onClick:l,className:"w-full flex items-center gap-2 px-4 py-2.5 text-sm text-text-secondary hover:text-error hover:bg-error/5 transition-all",children:[S.jsx(LM,{size:14}),"Sign Out"]})]})]})]})]})}function x2(){const{isARMode:t}=Ur(),[e,n]=U.useState("catalog");return S.jsxs("div",{className:"h-[100dvh] w-screen flex flex-col bg-bg-primary overflow-hidden page-enter",children:[S.jsx(_2,{}),S.jsx("div",{className:"flex-shrink-0 overflow-x-auto bg-bg-secondary border-b border-border custom-scroll",children:S.jsx(v2,{})}),S.jsxs("div",{className:"hidden lg:flex flex-1 overflow-hidden min-h-0",children:[S.jsx($p,{}),S.jsx("main",{className:"flex-1 flex flex-col overflow-hidden min-w-0",children:S.jsx("div",{className:"flex-1 p-3 overflow-hidden",children:t?S.jsx("div",{className:"w-full h-full rounded-2xl overflow-hidden border border-border bg-bg-secondary",children:S.jsx(eg,{})}):S.jsx(Jm,{})})}),S.jsx(tg,{})]}),S.jsxs("div",{className:"lg:hidden flex-1 min-h-0 flex flex-col overflow-y-auto",children:[S.jsx("main",{className:"flex-shrink-0 h-[40dvh] min-h-[16rem] max-h-[24rem] p-2 sm:p-3 overflow-hidden",children:S.jsx("div",{className:"w-full h-full rounded-2xl overflow-hidden border border-border bg-bg-secondary",children:t?S.jsx(eg,{}):S.jsx(Jm,{})})}),S.jsxs("section",{className:"flex flex-col flex-1 min-h-[20rem] border-t border-border bg-bg-secondary",children:[S.jsx("div",{className:"px-3 pt-3",children:S.jsxs("div",{className:"grid grid-cols-2 gap-2 rounded-2xl bg-bg-elevated p-1 border border-border",children:[S.jsx("button",{onClick:()=>n("catalog"),className:`rounded-xl px-4 py-2 text-sm font-medium transition-all ${e==="catalog"?"bg-accent text-bg-primary":"text-text-secondary hover:text-text-primary"}`,children:"Catalog"}),S.jsx("button",{onClick:()=>n("scene"),className:`rounded-xl px-4 py-2 text-sm font-medium transition-all ${e==="scene"?"bg-accent text-bg-primary":"text-text-secondary hover:text-text-primary"}`,children:"Scene"})]})}),S.jsx("div",{className:"flex-1 min-h-[18rem] overflow-hidden pb-3",children:e==="catalog"?S.jsx($p,{}):S.jsx(tg,{})})]})]})]})}function y2(){return S.jsx(aM,{children:S.jsx(gM,{children:S.jsxs(QS,{children:[S.jsx(da,{path:"/",element:S.jsx(HM,{})}),S.jsx(da,{path:"/tutorial",element:S.jsx(Wp,{children:S.jsx(GM,{})})}),S.jsx(da,{path:"/app",element:S.jsx(Wp,{children:S.jsx(x2,{})})}),S.jsx(da,{path:"*",element:S.jsx(Rv,{to:"/",replace:!0})})]})})})}Tu.createRoot(document.getElementById("root")).render(S.jsx(hg.StrictMode,{children:S.jsx(tM,{children:S.jsx(y2,{})})}));
